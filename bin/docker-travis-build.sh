...
apt-get -yq --no-install-suggests --no-install-recommends --force-yes install g++-4.9 g++-5 g++-6 g++-7 libeigen3-dev libboost1.55-all-dev libblas-dev liblapack-dev libtbb-dev clang-5.0 cmake cmake-data
