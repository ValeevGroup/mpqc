...
function check_package {
  brew info $1 | grep -q "Not installed" && brew install $1
  echo "dependency \"$1\" satisfied"
}
...
#    - libint
#wget https://github.com/evaleev/libint/releases/download/v2.3.0-beta.3/libint-2.3.0-beta.3.tgz && tar -xvzf libint-2.3.0-beta.3.tgz && cd libint-2.3.0-beta.3 && ./configure --prefix=$PREFIX --with-incdirs="-I/usr/local/include/eigen3" && make -j2 && make install && make clean && cd .. && rm -rf libint-2.3.0-beta.3
#    - tiledarray
