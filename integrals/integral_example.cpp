...
int main(int argc, char *argv[]) {
    ...
    for(auto const &cluster : basis.cluster_shells()){
        ...
        auto temp_nprim = std::max_element(shell_vec.begin(), shell_vec.end(), 
                [](libint2::Shell const &s, libint2::Shell const &t){
                return t.nprim() > s.nprim();})->nprim();
    ...
    libint2::TwoBodyEngine<libint2::Coulomb> coulomb_ints{max_nprim, static_cast<int>(max_am)};
