...
inline libint2::OneBodyEngine make_1body(std::string const &type,
                                         basis::Basis const &bs,
...
inline ShrPool<libint2::OneBodyEngine> make_1body_shr_pool(
    std::string const &type, basis::Basis const &bs,
    molecule::Molecule const &mol) {
