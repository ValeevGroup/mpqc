...
/*
 *  Componentwise logical and of a vector over all processors,
 *  using given topology.
 *
 *  buf        array of data to be combined by logical and.
 ...
 */
{
	...
	gcomb0(buf, items, datatype, msgtype, root, and0) ;
}

void and0 ( p1, p2, items, datatype)
	char *p1, *p2 ;
	int items, datatype ;
{
	char *c1, *c2 ;
