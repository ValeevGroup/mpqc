...
/*
 *  Componentwise product of a vector over all processors,
 *  using given topology.
 *
 *  buf        array of data to be combined by multiplication.
 ...
 */
{
	...
	gcomb0(buf, items, datatype, msgtype, root, prod0) ;
}

void prod0 ( p1, p2, items, datatype)
	char *p1, *p2 ;
	int items, datatype ;
{
	char *c1, *c2 ;
