...
/*
 *  Componentwise logical exclusive or of a vector over all
 *  processors, using given topology.
 *
 *  buf        array of data to be combined by exclusive or.
 ...
 */
{
	...
	gcomb0(buf, items, datatype, msgtype, root, xor0) ;
}

void xor0 ( p1, p2, items, datatype)
	char *p1, *p2 ;
	int items, datatype ;
{
	char *c1, *c2 ;
