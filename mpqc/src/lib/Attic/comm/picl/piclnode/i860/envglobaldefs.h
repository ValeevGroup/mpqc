...
/* envglobal definitions for iPSC/860 nodelib */
...
#define  CALCDRIFT   1
#define  DSLEEP     60
                      /* message type to tell the nodes what envNPA shoudl be */
...
unsigned long envTIMESTAMP[2];
                      /* global index variable */
long envI;
                      /* array of message IDs of pending isends */
struct cell envISARRAY[] ={
            {-2, -2, NULL},
            {-2, -2, NULL},
            {-2, -2, NULL},
            {-2, -2, NULL},
...
struct cell *envIRHEAD = NULL;
                      /* pointer to tail of list of pending irecvs */
struct cell *envIRTAIL = NULL;
                      /* pointer to head of empty irecv cells */
struct cell *envIRFREE = NULL;
