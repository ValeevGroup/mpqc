...
// DO-NOT-DELETE splicer.begin(MPQC.IntegralEvaluator2._hincludes)
#include "integral_evaluator.h"
#include "reorder_engine.h"
using namespace sc;
using namespace Chemistry::QC::GaussianBasis;
using namespace MpqcCca;
// DO-NOT-DELETE splicer.end(MPQC.IntegralEvaluator2._hincludes)
...
namespace MPQC { 
  ...
  public:
    ...
    // (fixes bug #275)
      IntegralEvaluator2_impl( struct MPQC_IntegralEvaluator2__object * ior ) : 
        StubBase(ior,true), 
    ...
    ::Chemistry::QC::GaussianBasis::IntegralEvaluator2Interface((ior==NULL) ? 
      NULL : &((
      *ior).d_chemistry_qc_gaussianbasis_integralevaluator2interface)) , 
      _wrapped(false) {
      ior->d_data = this;
      _ctor();
    }
...
// DO-NOT-DELETE splicer.begin(MPQC.IntegralEvaluator2._hmisc)
// Put miscellaneous things here...
// DO-NOT-DELETE splicer.end(MPQC.IntegralEvaluator2._hmisc)
