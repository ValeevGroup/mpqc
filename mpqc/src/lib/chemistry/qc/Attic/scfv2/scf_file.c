 ...
 * Initial revision
 *
 * Revision 1.2  1992/04/06  12:48:37  seidl
 * include stdio
 *
 * Revision 1.1.1.1  1992/03/17  17:08:35  seidl
 * DOE-NIH Quantum Chemistry Library 0.0
 *
 * Revision 1.1  1992/03/17  17:08:32  seidl
 * Initial revision
 *
...
GLOBAL_FUNCTION int
scf_open_files(si,sym_i,irr,cen,mfp,mf,cl_scr,op_scr,_node,outfile)
scf_struct_t *si;
sym_struct_t *sym_i;
scf_irreps_t *irr;
centers_t *cen;
