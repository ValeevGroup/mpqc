...
CCSD_2T_LEFT::CCSD_2T_LEFT(CCR12_Info* info): Parenthesis2tNum(info) {
...
if (toggle==1L) {
i1xn.at(0)=new Tensor("ccsd_2t_left_1x0_0",z->mem());
offset_smith_0_2();
smith_0_2_0(); //z->f1()=>in.at(1x0)
smith_1_5(); //z->t1(),z->v2()=>in.at(1x0)
}
if (toggle==2L) {
smith_0_2(a_i0,t_h4b,t_h5b,t_h6b,t_p1b,t_p2b,t_p3b);
}
if (toggle==1L) {
i1xn.at(1)=new Tensor("ccsd_2t_left_1x1_1",z->mem());
offset_smith_0_3();
smith_0_3_0(); //z->v2()=>in.at(1x1)
smith_1_6(); //z->t1(),z->v2()=>in.at(1x1)
}
if (toggle==2L) {
...
if (toggle==1L) {
i1xn.at(2)=new Tensor("ccsd_2t_left_1x2_7",z->mem());
offset_smith_0_7();
smith_1_7(); //z->t1(),z->lambda2()=>in.at(1x2)
}
if (toggle==2L) {
smith_0_7(a_i0,t_h4b,t_h5b,t_h6b,t_p1b,t_p2b,t_p3b);
}
if (toggle==3L) {
delete i1xn.at(2);
delete i1xn.at(1);
...
void CCSD_2T_LEFT::smith_0_1(double* a_i0,const long t_h4b,const long t_h5b,const long t_h6b,const long t_p1b,const long t_p2b,const long t_p3b){ 
    ...
    if (z->get_spin(h4b)==z->get_spin(p1b)) { 
     if ((z->get_sym(h4b)^z->get_sym(p1b))==z->irrep_y()) { 
      ...
      if (dima0>0L && dima1>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(p1b),1,0,+1.0,false); 
       ...
       z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p2b),z->get_range(p3b),3,2,1,0,+1.0,false); 
...
void CCSD_2T_LEFT::smith_0_2(double* a_i0,const long t_h4b,const long t_h5b,const long t_h6b,const long t_p1b,const long t_p2b,const long t_p3b){ 
    ...
    if (z->get_spin(h4b)+z->get_spin(h5b)==z->get_spin(p1b)+z->get_spin(p2b)) { 
     if ((z->get_sym(h4b)^(z->get_sym(h5b)^(z->get_sym(p1b)^z->get_sym(p2b))))==z->irrep_y()) { 
      ...
      if (dima0>0L && dima1>0L) { 
       ...
       z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h5b),z->get_range(p1b),z->get_range(p2b),3,2,1,0,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
       double* k_a1=z->mem()->malloc_local_double(dima1); 
       i1xn[0]->get_block(p3b_1-z->noab()+z->nvab()*(h6b_1),k_a1); 
       z->sort_indices2(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(p3b),1,0,+1.0,false); 
       z->mem()->free_local_double(k_a1); 
       double factor=1.0; 
       z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
       z->mem()->free_local_double(k_a1_sort); 
    ...
    if (z->get_spin(h6b)==z->get_spin(p3b)) { 
     if ((z->get_sym(h6b)^z->get_sym(p3b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(p3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h6b),z->get_range(p3b),0,1,+1.0,false); 
...
void CCSD_2T_LEFT::offset_smith_0_2(){ 
...
void CCSD_2T_LEFT::smith_0_3(double* a_i0,const long t_h4b,const long t_h5b,const long t_h6b,const long t_p1b,const long t_p2b,const long t_p3b){ 
      ...
      if ((z->get_sym(h4b)^(z->get_sym(h7b)^(z->get_sym(p1b)^z->get_sym(p2b))))==z->irrep_y()) { 
       ...
       if (dima0>0L && dima1>0L) { 
        ...
        if (h4b<h7b) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h7b),z->get_range(p1b),z->get_range(p2b),3,2,0,1,+1.0,false); 
        } 
        else if (h7b<=h4b) { 
         z->lambda2()->get_block(p2b_0-z->noab()+z->nvab()*(p1b_0-z->noab()+z->nvab()*(h4b_0+z->noab()*(h7b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h4b),z->get_range(p1b),z->get_range(p2b),3,2,1,0,-1.0,false); 
        } 
        z->mem()->free_local_double(k_a0); 
        double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
        double* k_a1=z->mem()->malloc_local_double(dima1); 
        i1xn[1]->get_block(p3b_1-z->noab()+z->nvab()*(h7b_1+z->noab()*(h6b_1+z->noab()*(h5b_1))),k_a1); 
        z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(h7b),z->get_range(p3b),3,1,0,2,+1.0,false); 
        z->mem()->free_local_double(k_a1); 
        double factor=1.0; 
        z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        z->mem()->free_local_double(k_a1_sort); 
      ...
      if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h7b)+z->get_spin(p3b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h7b)^z->get_sym(p3b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(h7b),z->get_range(p3b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h5b),z->get_range(h6b),z->get_range(h7b),z->get_range(p3b),0,1,2,3,-1.0,false); 
...
void CCSD_2T_LEFT::offset_smith_0_3(){ 
...
void CCSD_2T_LEFT::smith_0_4(double* a_i0,const long t_h4b,const long t_h5b,const long t_h6b,const long t_p1b,const long t_p2b,const long t_p3b){ 
      ...
      if ((z->get_sym(h4b)^(z->get_sym(h5b)^(z->get_sym(p1b)^z->get_sym(p7b))))==z->irrep_y()) { 
       ...
       if (dima0>0L && dima1>0L) { 
        ...
        if (p1b<p7b) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h5b),z->get_range(p1b),z->get_range(p7b),2,1,0,3,+1.0,false); 
        } 
        else if (p7b<=p1b) { 
         z->lambda2()->get_block(p1b_0-z->noab()+z->nvab()*(p7b_0-z->noab()+z->nvab()*(h5b_0+z->noab()*(h4b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h5b),z->get_range(p7b),z->get_range(p1b),3,1,0,2,-1.0,false); 
        } 
        z->mem()->free_local_double(k_a0); 
        double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
        double* k_a1=z->mem()->malloc_local_double(dima1); 
        z->v2()->get_block(p3b_1+(z->nab())*(p2b_1+(z->nab())*(p7b_1+(z->nab())*(h6b_1))),k_a1); 
        z->sort_indices4(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(p7b),z->get_range(p2b),z->get_range(p3b),3,2,0,1,+1.0,false); 
        z->mem()->free_local_double(k_a1); 
        double factor=1.0; 
        z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        z->mem()->free_local_double(k_a1_sort); 
...
void CCSD_2T_LEFT::smith_0_7(double* a_i0,const long t_h4b,const long t_h5b,const long t_h6b,const long t_p1b,const long t_p2b,const long t_p3b){ 
...
void CCSD_2T_LEFT::offset_smith_0_7(){ 
   ...
   if (!z->restricted() || z->get_spin(h6b)+z->get_spin(p3b)!=4L) { 
    if (z->get_spin(h6b)==z->get_spin(p3b)) { 
     if ((z->get_sym(h6b)^z->get_sym(p3b))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if ((z->get_sym(p7b)^z->get_sym(h8b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           if (h6b<h8b && p3b<p7b) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(h8b),z->get_range(p3b),z->get_range(p7b),2,0,3,1,+1.0,false); 
           } 
           else if (h6b<h8b && p7b<=p3b) { 
            z->v2()->get_block(p3b_1+(z->nab())*(p7b_1+(z->nab())*(h8b_1+(z->nab())*(h6b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(h8b),z->get_range(p7b),z->get_range(p3b),3,0,2,1,-1.0,false); 
           } 
           else if (h8b<=h6b && p3b<p7b) { 
            z->v2()->get_block(p7b_1+(z->nab())*(p3b_1+(z->nab())*(h6b_1+(z->nab())*(h8b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h6b),z->get_range(p3b),z->get_range(p7b),2,1,3,0,-1.0,false); 
           } 
           else if (h8b<=h6b && p7b<=p3b) { 
            z->v2()->get_block(p3b_1+(z->nab())*(p7b_1+(z->nab())*(h6b_1+(z->nab())*(h8b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h6b),z->get_range(p7b),z->get_range(p3b),3,1,2,0,+1.0,false); 
           } 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(p3b),z->get_range(h6b),1,0,+1.0,false); 
      i1xn[0]->add_block(p3b-z->noab()+z->nvab()*(h6b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
     ...
     if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h6b)+z->get_spin(h7b)+z->get_spin(p3b)!=8L) { 
      if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h7b)+z->get_spin(p3b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h7b)^z->get_sym(p3b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p8b)==z->get_spin(h7b)) { 
          if ((z->get_sym(p8b)^z->get_sym(h7b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices2(k_a0,k_a0_sort,z->get_range(p8b),z->get_range(h7b),1,0,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (p3b<p8b) { 
             z->v2()->get_block(p8b_1+(z->nab())*(p3b_1+(z->nab())*(h6b_1+(z->nab())*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p3b),z->get_range(p8b),2,1,0,3,+1.0,false); 
            } 
            else if (p8b<=p3b) { 
             z->v2()->get_block(p3b_1+(z->nab())*(p8b_1+(z->nab())*(h6b_1+(z->nab())*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p8b),z->get_range(p3b),3,1,0,2,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p3b),z->get_range(h6b),z->get_range(h5b),z->get_range(h7b),2,1,3,0,+1.0,false); 
        i1xn[1]->add_block(p3b-z->noab()+z->nvab()*(h7b+z->noab()*(h6b+z->noab()*(h5b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
