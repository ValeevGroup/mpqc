...
CCSD_R12_PT_RIGHT::CCSD_R12_PT_RIGHT(CCR12_Info* info): Parenthesis2tNum(info){};
  
  
void CCSD_R12_PT_RIGHT::compute_amp(double* a_i0,const long t_p4b,const long t_p5b,const long t_p6b,const long t_h1b,const long t_h2b,const long t_h3b,const long toggle){
...
void CCSD_R12_PT_RIGHT::smith_0_1(double* a_i0,const long t_p4b,const long t_p5b,const long t_p6b,const long t_h1b,const long t_h2b,const long t_h3b){ 
...
void CCSD_R12_PT_RIGHT::smith_0_2(double* a_i0,const long t_p4b,const long t_p5b,const long t_p6b,const long t_h1b,const long t_h2b,const long t_h3b){ 
...
void CCSD_R12_PT_RIGHT::smith_0_3(double* a_i0,const long t_p4b,const long t_p5b,const long t_p6b,const long t_h1b,const long t_h2b,const long t_h3b){ 
     ...
     if (z->get_spin(p4b)+z->get_spin(q7b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
      if ((z->get_sym(p4b)^(z->get_sym(q7b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
       ...
       if (dima0>0L && dima1>0L) { 
        ...
        double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
        double* k_a1=z->mem()->malloc_local_double(dima1); 
        z->v2()->get_block(q7b_1+(z->nab())*(h3b_1+(z->nab())*(p6b_1+(z->nab())*(p5b_1))),k_a1); 
