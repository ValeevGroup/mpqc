//
#ifndef _chemistry_qc_ccr12_ccsd_ccsd_r12_pt_right_h
#define _chemistry_qc_ccr12_ccsd_ccsd_r12_pt_right_h
...
class CCSD_R12_PT_RIGHT : public Parenthesis2tNum {
  ...
  public:
   CCSD_R12_PT_RIGHT(CCR12_Info* info);
