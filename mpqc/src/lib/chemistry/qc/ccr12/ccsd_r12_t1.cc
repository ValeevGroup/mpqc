...
CCSD_R12_T1::CCSD_R12_T1(CCR12_Info* info):z(info){};
CCSD_R12_T1::~CCSD_R12_T1(){};
  
  
  
void CCSD_R12_T1::compute_amp(Ref<Tensor>& out){ //k_i0_offset,z->gt2(),z->f1(),z->in.at(0),z->qy(),z->t1(),z->t2(),z->v2()=>z->vr2()
  
in.resize(8);
kn.resize(64);
  
kn.at(0)=new Tensor("ccsd_r12_t1_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
smith_0_1(out); //z->f1()=>out
in.at(1)=new Tensor("ccsd_r12_t1_1_0",z->mem());
offset_smith_0_2();
smith_0_2_0(); //z->f1()=>in.at(1)
in.at(2)=new Tensor("ccsd_r12_t1_2_0",z->mem());
offset_smith_1_4();
smith_1_4_0(); //z->f1()=>in.at(2)
smith_1_4_1(); //kn.at(0)=>in.at(2)
smith_1_4(); //z->t1(),in.at(2)=>in.at(1)
delete in.at(2);
smith_1_8(); //z->t1(),z->v2()=>in.at(1)
smith_1_17(); //z->t2(),z->v2()=>in.at(1)
smith_1_20(); //z->gt2(),z->vr2()=>in.at(1)
smith_0_2(out); //z->t1(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t1_1_1",z->mem());
offset_smith_0_3();
smith_0_3_0(); //z->f1()=>in.at(1)
smith_1_9(); //z->t1(),z->v2()=>in.at(1)
smith_0_3(out); //z->t1(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t1_1_2",z->mem());
offset_smith_0_5();
smith_0_5_0(); //z->f1()=>in.at(1)
smith_0_5_1(); //kn.at(0)=>in.at(1)
smith_0_5(out); //z->t2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t1_1_3",z->mem());
offset_smith_0_6();
smith_0_6_0(); //z->f1()=>in.at(1)
smith_1_18(); //z->t1(),z->v2()=>in.at(1)
smith_0_6(out); //z->qy(),in.at(1)=>out
delete in.at(1);
smith_0_7(out); //z->t1(),z->v2()=>out
in.at(1)=new Tensor("ccsd_r12_t1_1_4",z->mem());
offset_smith_0_10();
smith_0_10_0(); //z->v2()=>in.at(1)
smith_1_16(); //z->t1(),z->v2()=>in.at(1)
smith_0_10(out); //z->t2(),in.at(1)=>out
delete in.at(1);
smith_0_11(out); //z->t2(),z->v2()=>out
in.at(1)=new Tensor("ccsd_r12_t1_1_5",z->mem());
offset_smith_0_12();
smith_0_12_0(); //z->v2()=>in.at(1)
smith_1_19(); //z->t1(),z->v2()=>in.at(1)
smith_0_12(out); //z->qy(),in.at(1)=>out
delete in.at(1);
smith_0_13(out); //z->gt2(),z->vr2()=>out
delete kn.at(0);
  
}
  
void CCSD_R12_T1::offset_k0(){ 
...
void CCSD_R12_T1::smith_0_1(Ref<Tensor>& out){ 
    ...
    if (z->get_spin(p2b)==z->get_spin(h1b)) { 
     if ((z->get_sym(p2b)^z->get_sym(h1b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(p2b),z->get_range(h1b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(p2b),z->get_range(h1b),0,1,+1.0,false); 
...
void CCSD_R12_T1::smith_0_10(Ref<Tensor>& out){ 
...
void CCSD_R12_T1::offset_smith_0_10(){ 
...
void CCSD_R12_T1::smith_0_11(Ref<Tensor>& out){ 
...
void CCSD_R12_T1::smith_0_12(Ref<Tensor>& out){ 
...
void CCSD_R12_T1::offset_smith_0_12(){ 
...
void CCSD_R12_T1::smith_0_13(Ref<Tensor>& out){ 
...
void CCSD_R12_T1::smith_0_2(Ref<Tensor>& out){ 
...
void CCSD_R12_T1::offset_smith_0_2(){ 
...
void CCSD_R12_T1::smith_0_3(Ref<Tensor>& out){ 
...
void CCSD_R12_T1::offset_smith_0_3(){ 
...
void CCSD_R12_T1::smith_0_5(Ref<Tensor>& out){ 
    ...
    if (z->get_spin(h4b)==z->get_spin(p3b)) { 
     if ((z->get_sym(h4b)^z->get_sym(p3b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(p3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h4b),z->get_range(p3b),0,1,+1.0,false); 
    ...
    if (z->get_spin(h4b)==z->get_spin(p3b)) { 
     if ((z->get_sym(h4b)^z->get_sym(p3b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[0]->get_block(p3b_0-z->noab()+z->nvab()*(h4b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(p3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h4b),z->get_range(p3b),0,1,+1.0,false); 
...
void CCSD_R12_T1::offset_smith_0_5(){ 
...
void CCSD_R12_T1::smith_0_6(Ref<Tensor>& out){ 
...
for (long p2b=z->noab();p2b<z->noab()+z->nvab();++p2b) { 
 for (long h1b=0L;h1b<z->noab();++h1b) { 
  ...
  if (out->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(p2b)+z->get_spin(h1b)!=4L) { 
    if (z->get_spin(p2b)==z->get_spin(h1b)) { 
     if ((z->get_sym(p2b)^z->get_sym(h1b))==(z->irrep_e()^z->irrep_f())) { 
      long dimc=z->get_range(p2b)*z->get_range(h1b); 
      double* k_c_sort=z->mem()->malloc_local_double(dimc); 
      std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
      for (long h4b=0L;h4b<z->noab();++h4b) { 
  ...
  if (in[1]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h4b)+z->get_spin(q3b)!=4L) { 
    if (z->get_spin(h4b)==z->get_spin(q3b)) { 
     if ((z->get_sym(h4b)^z->get_sym(q3b))==z->irrep_f()) { 
      long dimc=z->get_range(h4b)*z->get_range(q3b); 
      long h4b_0,q3b_0; 
      z->restricted_2(h4b,q3b,h4b_0,q3b_0); 
      long dim_common=1L; 
      long dima0_sort=z->get_range(h4b)*z->get_range(q3b); 
      long dima0=dim_common*dima0_sort; 
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       z->f1()->get_block(q3b_0+(z->nab())*(h4b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(q3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h4b),z->get_range(q3b),0,1,+1.0,false); 
...
void CCSD_R12_T1::offset_smith_0_6(){ 
...
void CCSD_R12_T1::smith_0_7(Ref<Tensor>& out){ 
    ...
    if (z->get_spin(h3b)==z->get_spin(p4b)) { 
     if ((z->get_sym(h3b)^z->get_sym(p4b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(p4b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h3b),z->get_range(p4b),0,1,-1.0,false); 
    ...
    if (z->get_spin(h3b)==z->get_spin(p4b)) { 
     if ((z->get_sym(h3b)^z->get_sym(p4b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[0]->get_block(p4b_0-z->noab()+z->nvab()*(h3b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(p4b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h3b),z->get_range(p4b),0,1,-1.0,false); 
...
void CCSD_R12_T1::offset_smith_1_4(){ 
