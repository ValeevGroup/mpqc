...
CCSD_R12_T2::CCSD_R12_T2(CCR12_Info* info):z(info){};
CCSD_R12_T2::~CCSD_R12_T2(){};
  
  
  
void CCSD_R12_T2::compute_amp(Ref<Tensor>& out){ //k_i0_offset,z->gt2(),z->f1(),z->in.at(0),z->qy(),z->t1(),z->t2(),z->v2()=>z->vr2()
  
in.resize(8);
kn.resize(64);
  
kn.at(0)=new Tensor("ccsd_r12_t2_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
kn.at(1)=new Tensor("ccsd_r12_t2_k1",z->mem());
offset_k1();
smith_k1(); //z->t1(),z->v2()=>kn.at(1)
kn.at(2)=new Tensor("ccsd_r12_t2_k2",z->mem());
offset_k2();
smith_k2(); //z->t1(),z->v2()=>kn.at(2)
kn.at(3)=new Tensor("ccsd_r12_t2_k3",z->mem());
offset_k3();
smith_k3(); //z->gt2(),z->vr2()=>kn.at(3)
kn.at(4)=new Tensor("ccsd_r12_t2_k4",z->mem());
offset_k4();
smith_k4(); //z->t2(),z->v2()=>kn.at(4)
kn.at(5)=new Tensor("ccsd_r12_t2_k5",z->mem());
offset_k5();
smith_k5(); //z->t1(),z->v2()=>kn.at(5)
kn.at(6)=new Tensor("ccsd_r12_t2_k6",z->mem());
offset_k6();
smith_k6(); //z->t1(),kn.at(2)=>kn.at(6)
in.at(1)=new Tensor("ccsd_r12_t2_1_0",z->mem());
offset_smith_0_1();
smith_0_1_0(); //z->f1()=>in.at(1)
in.at(2)=new Tensor("ccsd_r12_t2_2_0",z->mem());
offset_smith_1_6();
smith_1_6_0(); //z->f1()=>in.at(2)
smith_1_6_1(); //kn.at(5)=>in.at(2)
smith_1_6(); //z->t1(),in.at(2)=>in.at(1)
delete in.at(2);
smith_1_28(); //z->t1(),z->v2()=>in.at(1)
smith_1_42(); //z->t2(),z->v2()=>in.at(1)
smith_1_47(); //z->gt2(),z->vr2()=>in.at(1)
smith_0_1(out); //z->t2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t2_1_1",z->mem());
offset_smith_0_2();
smith_0_2_0(); //z->f1()=>in.at(1)
smith_1_29(); //z->t1(),z->v2()=>in.at(1)
smith_1_40(); //z->t2(),z->v2()=>in.at(1)
smith_1_45(); //z->qy(),z->v2()=>in.at(1)
smith_0_2(out); //z->t2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t2_1_2",z->mem());
offset_smith_0_3();
smith_0_3_0(); //z->f1()=>in.at(1)
smith_1_20(); //z->t1(),z->v2()=>in.at(1)
smith_1_43(); //z->t2(),z->v2()=>in.at(1)
smith_1_49(); //z->qy(),z->v2()=>in.at(1)
smith_0_3(out); //z->qy(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t2_1_3",z->mem());
offset_smith_0_4();
...
smith_1_4(); //z->qy(),in.at(2)=>in.at(1)
delete in.at(2);
in.at(2)=new Tensor("ccsd_r12_t2_2_1",z->mem());
offset_smith_1_5();
smith_1_5_0(); //z->f1()=>in.at(2)
smith_1_5_1(); //kn.at(5)=>in.at(2)
smith_1_5(); //z->t2(),in.at(2)=>in.at(1)
delete in.at(2);
in.at(2)=new Tensor("ccsd_r12_t2_2_2",z->mem());
offset_smith_1_10();
smith_1_10_0(); //z->v2()=>in.at(2)
smith_1_10_1(); //kn.at(0)=>in.at(2)
smith_1_10_2(); //kn.at(6)=>in.at(2)
smith_1_10_3(); //kn.at(3)=>in.at(2)
smith_1_10_4(); //kn.at(4)=>in.at(2)
smith_1_10(); //z->t1(),in.at(2)=>in.at(1)
delete in.at(2);
in.at(2)=new Tensor("ccsd_r12_t2_2_3",z->mem());
offset_smith_1_11();
smith_1_11_0(); //z->v2()=>in.at(2)
smith_1_11_1(); //kn.at(1)=>in.at(2)
smith_1_11(); //z->t1(),in.at(2)=>in.at(1)
delete in.at(2);
in.at(2)=new Tensor("ccsd_r12_t2_2_4",z->mem());
offset_smith_1_21();
smith_1_21_0(); //z->v2()=>in.at(2)
smith_2_32(); //z->t1(),z->v2()=>in.at(2)
smith_1_21(); //z->qy(),in.at(2)=>in.at(1)
delete in.at(2);
smith_1_23(); //z->gt2(),z->vr2()=>in.at(1)
in.at(2)=new Tensor("ccsd_r12_t2_2_5",z->mem());
offset_smith_1_24();
smith_1_24_0(); //z->v2()=>in.at(2)
smith_1_24_1(); //kn.at(2)=>in.at(2)
smith_1_24(); //z->t2(),in.at(2)=>in.at(1)
delete in.at(2);
smith_1_25(); //z->t2(),z->v2()=>in.at(1)
smith_0_4(out); //z->t1(),in.at(1)=>out
delete in.at(1);
smith_0_7(out); //z->v2()=>out
in.at(1)=new Tensor("ccsd_r12_t2_1_4",z->mem());
offset_smith_0_9();
smith_0_9_0(); //z->v2()=>in.at(1)
smith_1_12(); //z->t1(),z->v2()=>in.at(1)
smith_0_9(out); //z->t1(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t2_1_5",z->mem());
offset_smith_0_13();
smith_0_13_0(); //z->v2()=>in.at(1)
smith_0_13_1(); //kn.at(0)=>in.at(1)
smith_0_13_2(); //kn.at(6)=>in.at(1)
smith_0_13_3(); //kn.at(4)=>in.at(1)
smith_0_13_4(); //kn.at(3)=>in.at(1)
smith_0_13(out); //z->t2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsd_r12_t2_1_6",z->mem());
offset_smith_0_14();
smith_0_14_0(); //z->v2()=>in.at(1)
smith_0_14_1(); //kn.at(1)=>in.at(1)
smith_1_39(); //z->t2(),z->v2()=>in.at(1)
smith_1_44(); //z->qy(),z->v2()=>in.at(1)
smith_0_14(out); //z->t2(),in.at(1)=>out
delete in.at(1);
smith_0_15(out); //z->t2(),z->v2()=>out
in.at(1)=new Tensor("ccsd_r12_t2_1_7",z->mem());
offset_smith_0_16();
smith_0_16_0(); //z->v2()=>in.at(1)
smith_1_22(); //z->t1(),z->v2()=>in.at(1)
smith_1_48(); //z->qy(),z->v2()=>in.at(1)
smith_0_16(out); //z->qy(),in.at(1)=>out
delete in.at(1);
smith_0_17(out); //z->gt2(),z->vr2()=>out
delete kn.at(6);
delete kn.at(5);
delete kn.at(4);
delete kn.at(3);
   ...
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
     if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^z->irrep_e())) { 
      if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
       kn[3]->input_offset(h2b+z->noab()*(h1b+z->noab()*(h6b+z->noab()*(h5b))),size); 
       size+=z->get_range(h5b)*z->get_range(h6b)*z->get_range(h1b)*z->get_range(h2b); 
      } 
     } 
    } 
  ...
  if (z->get_spin(h5b)==z->get_spin(p6b)) { 
   if ((z->get_sym(h5b)^z->get_sym(p6b))==(z->irrep_t()^z->irrep_v())) { 
    if (!z->restricted() || z->get_spin(h5b)+z->get_spin(p6b)!=4L) { 
     kn[5]->input_offset(p6b-z->noab()+z->nvab()*(h5b),size); 
   ...
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
     if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^(z->irrep_t()^z->irrep_v()))) { 
      if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
       kn[6]->input_offset(h2b+z->noab()*(h1b+z->noab()*(h6b+z->noab()*(h5b))),size); 
       size+=z->get_range(h5b)*z->get_range(h6b)*z->get_range(h1b)*z->get_range(h2b); 
      } 
     } 
    } 
...
void CCSD_R12_T2::smith_0_1(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::smith_0_13(Ref<Tensor>& out){ 
      ...
      if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[6]->get_block(h2b_0+z->noab()*(h1b_0+z->noab()*(h6b_0+z->noab()*(h5b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
      ...
      if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[3]->get_block(h2b_0+z->noab()*(h1b_0+z->noab()*(h6b_0+z->noab()*(h5b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
...
void CCSD_R12_T2::offset_smith_0_13(){ 
...
void CCSD_R12_T2::smith_0_14(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::offset_smith_0_14(){ 
...
void CCSD_R12_T2::smith_0_15(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::smith_0_16(Ref<Tensor>& out){ 
      ...
      if (z->get_spin(h6b)+z->get_spin(p4b)==z->get_spin(h2b)+z->get_spin(q5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(p4b)^(z->get_sym(h2b)^z->get_sym(q5b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(p4b),z->get_range(h2b),z->get_range(q5b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h6b),z->get_range(p4b),z->get_range(h2b),z->get_range(q5b),0,1,2,3,-1.0,false); 
...
void CCSD_R12_T2::offset_smith_0_16(){ 
...
void CCSD_R12_T2::smith_0_17(Ref<Tensor>& out){ 
          ...
          if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
           if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(p3b),z->get_range(p4b),z->get_range(h5b),z->get_range(h6b),1,0,3,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h5b==h6b) { 
              factor=factor/2.0; 
...
void CCSD_R12_T2::offset_smith_0_1(){ 
...
void CCSD_R12_T2::smith_0_2(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::offset_smith_0_2(){ 
...
void CCSD_R12_T2::smith_0_3(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::offset_smith_0_3(){ 
...
void CCSD_R12_T2::smith_0_4(Ref<Tensor>& out){ 
  ...
  for (long h1b=0L;h1b<z->noab();++h1b) { 
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    ...
    if (out->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(p3b)+z->get_spin(p4b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(p3b)+z->get_spin(p4b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(p3b)^(z->get_sym(p4b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^(z->irrep_e()^z->irrep_f()))) { 
        long dimc=z->get_range(p3b)*z->get_range(p4b)*z->get_range(h1b)*z->get_range(h2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h5b=0L;h5b<z->noab();++h5b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h5b)+z->get_spin(p4b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h5b)+z->get_spin(p4b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(p4b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_f())) { 
...
void CCSD_R12_T2::offset_smith_0_4(){ 
...
void CCSD_R12_T2::smith_0_7(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::smith_0_9(Ref<Tensor>& out){ 
...
void CCSD_R12_T2::offset_smith_0_9(){ 
...
void CCSD_R12_T2::offset_smith_1_10(){ 
...
void CCSD_R12_T2::offset_smith_1_11(){ 
   ...
   if (!z->restricted() || z->get_spin(p4b)+z->get_spin(q5b)!=4L) { 
    if (z->get_spin(p4b)==z->get_spin(q5b)) { 
     if ((z->get_sym(p4b)^z->get_sym(q5b))==(z->irrep_t()^z->irrep_v())) { 
        ...
        if (z->get_spin(p6b)==z->get_spin(h7b)) { 
         if ((z->get_sym(p6b)^z->get_sym(h7b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(p4b),z->get_range(p6b),z->get_range(q5b),3,1,2,0,+1.0,false); 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
           z->mem()->free_local_double(k_a1_sort); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q5b),z->get_range(p4b),1,0,+1.0,false); 
      in[1]->add_block(q5b-z->noab()-z->nvab()+z->ncab()*(p4b-z->noab()),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
           ...
           if ((z->get_sym(p4b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h7b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h1b<h7b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p4b),z->get_range(q6b),z->get_range(h1b),z->get_range(h7b),2,0,1,3,+1.0,false); 
             } 
             else if (h7b<=h1b) { 
              z->qy()->get_block(h1b_0+z->noab()*(h7b_0+z->noab()*(q6b_0-z->noab()-z->nvab()+z->ncab()*(p4b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p4b),z->get_range(q6b),z->get_range(h7b),z->get_range(h1b),3,0,1,2,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h5b<h7b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h7b),z->get_range(h2b),z->get_range(q6b),2,0,3,1,+1.0,false); 
             } 
             else if (h7b<=h5b) { 
              in[2]->get_block(q6b_1-z->noab()-z->nvab()+z->ncab()*(h2b_1+z->noab()*(h5b_1+z->noab()*(h7b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(h5b),z->get_range(h2b),z->get_range(q6b),2,1,3,0,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      if (z->get_spin(h5b)+z->get_spin(h7b)==z->get_spin(h2b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h7b)^(z->get_sym(h2b)^z->get_sym(q6b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h7b),z->get_range(h2b),z->get_range(q6b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h5b),z->get_range(h7b),z->get_range(h2b),z->get_range(q6b),0,1,2,3,+1.0,false); 
...
void CCSD_R12_T2::offset_smith_1_21(){ 
     ...
     if (!z->restricted() || z->get_spin(h6b)+z->get_spin(p4b)+z->get_spin(h2b)+z->get_spin(q5b)!=8L) { 
      if (z->get_spin(h6b)+z->get_spin(p4b)==z->get_spin(h2b)+z->get_spin(q5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(p4b)^(z->get_sym(h2b)^z->get_sym(q5b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p7b)==z->get_spin(h2b)) { 
          if ((z->get_sym(p7b)^z->get_sym(h2b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(p4b),z->get_range(p7b),z->get_range(q5b),3,1,0,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q5b),z->get_range(p4b),z->get_range(h6b),z->get_range(h2b),2,1,3,0,-1.0,false); 
        in[1]->add_block(q5b-z->noab()-z->nvab()+z->ncab()*(h2b+z->noab()*(p4b-z->noab()+z->nvab()*(h6b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
          ...
          if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
           if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h7b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->vr2()->get_block(h7b_1+z->noab()*(h6b_1+z->noab()*(p4b_1+(z->nab())*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(p4b),z->get_range(h6b),z->get_range(h7b),1,0,3,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h6b==h7b) { 
              factor=factor/2.0; 
...
void CCSD_R12_T2::offset_smith_1_24(){ 
         ...
         if (z->get_spin(p4b)+z->get_spin(q6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
          if ((z->get_sym(p4b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p4b),z->get_range(q6b),z->get_range(h1b),z->get_range(h2b),3,2,0,1,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            in[2]->get_block(q6b_1-z->noab()-z->nvab()+z->ncab()*(h5b_1),k_a1); 
            z->sort_indices2(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(q6b),0,1,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
     ...
     if (!z->restricted() || z->get_spin(h6b)+z->get_spin(p4b)+z->get_spin(h2b)+z->get_spin(p5b)!=8L) { 
      if (z->get_spin(h6b)+z->get_spin(p4b)==z->get_spin(h2b)+z->get_spin(p5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(p4b)^(z->get_sym(h2b)^z->get_sym(p5b))))==(z->irrep_e()^z->irrep_v())) { 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p5b),z->get_range(h6b),z->get_range(h2b),z->get_range(p4b),1,3,2,0,+1.0,false); 
        in[1]->add_block(p5b-z->noab()+z->nvab()*(h2b+z->noab()*(p4b-z->noab()+z->nvab()*(h6b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
          ...
          if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h2b)^z->get_sym(h8b))))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (h2b<h8b) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h7b),z->get_range(h2b),z->get_range(h8b),2,3,1,0,+1.0,false); 
            } 
            else if (h8b<=h2b) { 
             z->gt2()->get_block(h2b_0+z->noab()*(h8b_0+z->noab()*(h7b_0+z->noab()*(h6b_0))),k_a0); 
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h7b),z->get_range(h8b),z->get_range(h2b),3,2,1,0,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h5b<h8b) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h8b),z->get_range(h6b),z->get_range(h7b),0,1,3,2,+1.0,false); 
            } 
            else if (h8b<=h5b) { 
             z->vr2()->get_block(h7b_1+z->noab()*(h6b_1+z->noab()*(h5b_1+(z->nab())*(h8b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h5b),z->get_range(h6b),z->get_range(h7b),1,0,3,2,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            if (h6b==h7b) { 
  ...
  for (long h2b=0L;h2b<z->noab();++h2b) { 
   for (long q5b=z->noab()+z->nvab();q5b<z->nab();++q5b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h6b)+z->get_spin(p4b)+z->get_spin(h2b)+z->get_spin(q5b)!=8L) { 
      if (z->get_spin(h6b)+z->get_spin(p4b)==z->get_spin(h2b)+z->get_spin(q5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(p4b)^(z->get_sym(h2b)^z->get_sym(q5b))))==(z->irrep_e()^z->irrep_v())) { 
        long dimc=z->get_range(h6b)*z->get_range(p4b)*z->get_range(h2b)*z->get_range(q5b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h8b=0L;h8b<z->noab();++h8b) { 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q5b),z->get_range(h6b),z->get_range(h2b),z->get_range(p4b),1,3,2,0,+0.5,false); 
        in[1]->add_block(q5b-z->noab()-z->nvab()+z->ncab()*(h2b+z->noab()*(p4b-z->noab()+z->nvab()*(h6b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
...
for (long p4b=z->noab();p4b<z->noab()+z->nvab();++p4b) { 
 for (long q5b=z->noab()+z->nvab();q5b<z->nab();++q5b) { 
  ...
  if (in[1]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(p4b)+z->get_spin(q5b)!=4L) { 
    if (z->get_spin(p4b)==z->get_spin(q5b)) { 
     if ((z->get_sym(p4b)^z->get_sym(q5b))==(z->irrep_e()^z->irrep_v())) { 
      long dimc=z->get_range(p4b)*z->get_range(q5b); 
      double* k_c_sort=z->mem()->malloc_local_double(dimc); 
      std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
      for (long h7b=0L;h7b<z->noab();++h7b) { 
  ...
  if (in[2]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h5b)+z->get_spin(q6b)!=4L) { 
    if (z->get_spin(h5b)==z->get_spin(q6b)) { 
     if ((z->get_sym(h5b)^z->get_sym(q6b))==z->irrep_f()) { 
      long dimc=z->get_range(h5b)*z->get_range(q6b); 
      long h5b_0,q6b_0; 
      z->restricted_2(h5b,q6b,h5b_0,q6b_0); 
      long dim_common=1L; 
      long dima0_sort=z->get_range(h5b)*z->get_range(q6b); 
      long dima0=dim_common*dima0_sort; 
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       z->f1()->get_block(q6b_0+(z->nab())*(h5b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(q6b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h5b),z->get_range(q6b),0,1,+1.0,false); 
...
void CCSD_R12_T2::offset_smith_1_4(){ 
    ...
    if (z->get_spin(h5b)==z->get_spin(p6b)) { 
     if ((z->get_sym(h5b)^z->get_sym(p6b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[5]->get_block(p6b_0-z->noab()+z->nvab()*(h5b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(p6b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h5b),z->get_range(p6b),0,1,+1.0,false); 
...
void CCSD_R12_T2::offset_smith_1_5(){ 
...
void CCSD_R12_T2::offset_smith_1_6(){ 
   ...
   if (!z->restricted() || z->get_spin(h5b)+z->get_spin(q6b)!=4L) { 
    if (z->get_spin(h5b)==z->get_spin(q6b)) { 
     if ((z->get_sym(h5b)^z->get_sym(q6b))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if ((z->get_sym(p7b)^z->get_sym(h8b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           if (h5b<h8b) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h8b),z->get_range(p7b),z->get_range(q6b),3,0,2,1,+1.0,false); 
           } 
           else if (h8b<=h5b) { 
            z->v2()->get_block(q6b_1+(z->nab())*(p7b_1+(z->nab())*(h5b_1+(z->nab())*(h8b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h5b),z->get_range(p7b),z->get_range(q6b),3,1,2,0,-1.0,false); 
           } 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q6b),z->get_range(h5b),1,0,-1.0,false); 
      in[2]->add_block(q6b-z->noab()-z->nvab()+z->ncab()*(h5b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
     ...
     if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h7b)+z->get_spin(h2b)+z->get_spin(q6b)!=8L) { 
      if (z->get_spin(h5b)+z->get_spin(h7b)==z->get_spin(h2b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h7b)^(z->get_sym(h2b)^z->get_sym(q6b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p8b)==z->get_spin(h2b)) { 
          if ((z->get_sym(p8b)^z->get_sym(h2b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h7b),z->get_range(p8b),z->get_range(q6b),3,1,0,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q6b),z->get_range(h7b),z->get_range(h5b),z->get_range(h2b),2,1,3,0,+1.0,false); 
        in[2]->add_block(q6b-z->noab()-z->nvab()+z->ncab()*(h2b+z->noab()*(h7b+z->noab()*(h5b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^z->irrep_e())) { 
          ...
          if (z->get_spin(h7b)+z->get_spin(h8b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
           if ((z->get_sym(h7b)^(z->get_sym(h8b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h8b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->vr2()->get_block(h8b_1+z->noab()*(h7b_1+z->noab()*(h6b_1+(z->nab())*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(h7b),z->get_range(h8b),1,0,3,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h7b==h8b) { 
              factor=factor/2.0; 
        ...
        kn[3]->add_block(h2b+z->noab()*(h1b+z->noab()*(h6b+z->noab()*(h5b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
   ...
   if (!z->restricted() || z->get_spin(h5b)+z->get_spin(p6b)!=4L) { 
    if (z->get_spin(h5b)==z->get_spin(p6b)) { 
     if ((z->get_sym(h5b)^z->get_sym(p6b))==(z->irrep_t()^z->irrep_v())) { 
      ...
      kn[5]->add_block(p6b-z->noab()+z->nvab()*(h5b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
    } 
     ...
     if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h5b)+z->get_spin(h6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^(z->irrep_t()^z->irrep_v()))) { 
        ...
        if (h2b>=h1b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h2b),z->get_range(h6b),z->get_range(h5b),z->get_range(h1b),2,1,3,0,+1.0,false); 
         kn[6]->add_block(h2b+z->noab()*(h1b+z->noab()*(h6b+z->noab()*(h5b))),k_c); 
        } 
        if (h1b>=h2b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h2b),z->get_range(h6b),z->get_range(h5b),z->get_range(h1b),2,1,0,3,-1.0,false); 
         kn[6]->add_block(h1b+z->noab()*(h2b+z->noab()*(h6b+z->noab()*(h5b))),k_c); 
        } 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
