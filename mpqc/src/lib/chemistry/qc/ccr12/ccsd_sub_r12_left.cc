...
kn.at(0)=new Tensor("ccsd_sub_r12_left_k0",z->mem());
offset_k0();
smith_k0(); //z->fr2(),z->f1()=>kn.at(0)
kn.at(1)=new Tensor("ccsd_sub_r12_left_k1",z->mem());
offset_k1();
smith_k1(); //z->lambda1(),z->fr2()=>kn.at(1)
kn.at(2)=new Tensor("ccsd_sub_r12_left_k2",z->mem());
offset_k2();
smith_k2(); //z->t1(),z->v2()=>kn.at(2)
kn.at(3)=new Tensor("ccsd_sub_r12_left_k3",z->mem());
offset_k3();
smith_k3(); //z->t1(),z->lambda2()=>kn.at(3)
kn.at(4)=new Tensor("ccsd_sub_r12_left_k4",z->mem());
offset_k4();
smith_k4(); //z->fr2(),kn.at(2)=>kn.at(4)
smith_0_1(out); //z->vr2()=>out
in.at(1)=new Tensor("ccsd_sub_r12_left_1_0",z->mem());
offset_smith_0_2();
smith_0_2_0(); //kn.at(0)=>in.at(1)
smith_0_2_1(); //z->vr2()=>in.at(1)
smith_0_2_2(); //kn.at(4)=>in.at(1)
smith_0_2(out); //z->lambda1(),in.at(1)=>out
delete in.at(1);
smith_0_3(out); //z->v2(),kn.at(1)=>out
in.at(1)=new Tensor("ccsd_sub_r12_left_1_1",z->mem());
offset_smith_0_6();
smith_1_6(); //z->t1(),kn.at(1)=>in.at(1)
...
offset_smith_1_9();
smith_1_9_0(); //kn.at(0)=>in.at(2)
smith_1_9_1(); //kn.at(4)=>in.at(2)
...
void CCSD_SUB_R12_LEFT::offset_k0(){ 
    ...
    if (z->get_spin(h7b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
     if ((z->get_sym(h7b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_f())) { 
      if (!z->restricted() || z->get_spin(h7b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
       kn[0]->input_offset(h2b+z->noab()*(h1b+z->noab()*(p6b-z->noab()+z->nvab()*(h7b))),size); 
...
void CCSD_SUB_R12_LEFT::offset_k1(){ 
    ...
    if (z->get_spin(h7b)+z->get_spin(q6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
     if ((z->get_sym(h7b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_y()^z->irrep_e())) { 
      if (!z->restricted() || z->get_spin(h7b)+z->get_spin(q6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
       kn[1]->input_offset(h2b+z->noab()*(h1b+z->noab()*(q6b-z->noab()-z->nvab()+z->ncab()*(h7b))),size); 
...
void CCSD_SUB_R12_LEFT::offset_k2(){ 
  ...
  if (z->get_spin(h7b)==z->get_spin(q8b)) { 
   if ((z->get_sym(h7b)^z->get_sym(q8b))==(z->irrep_t()^z->irrep_v())) { 
    if (!z->restricted() || z->get_spin(h7b)+z->get_spin(q8b)!=4L) { 
     kn[2]->input_offset(q8b-z->noab()-z->nvab()+z->ncab()*(h7b),size); 
...
void CCSD_SUB_R12_LEFT::offset_k3(){ 
    ...
    if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h6b)+z->get_spin(p7b)) { 
     if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h6b)^z->get_sym(p7b))))==(z->irrep_t()^z->irrep_y())) { 
      if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(h6b)+z->get_spin(p7b)!=8L) { 
       kn[3]->input_offset(p7b-z->noab()+z->nvab()*(h6b+z->noab()*(h4b+z->noab()*(h3b))),size); 
...
void CCSD_SUB_R12_LEFT::offset_k4(){ 
...
for (long h7b=0L;h7b<z->noab();++h7b) { 
 for (long p6b=z->noab();p6b<z->noab()+z->nvab();++p6b) { 
  for (long h1b=0L;h1b<z->noab();++h1b) { 
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    if (z->get_spin(h7b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
     if ((z->get_sym(h7b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_v())) { 
      if (!z->restricted() || z->get_spin(h7b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
       kn[4]->input_offset(h2b+z->noab()*(h1b+z->noab()*(p6b-z->noab()+z->nvab()*(h7b))),size); 
       size+=z->get_range(h7b)*z->get_range(p6b)*z->get_range(h1b)*z->get_range(h2b); 
      } 
     } 
    } 
          ...
          if (z->get_spin(p5b)+z->get_spin(q6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
           if ((z->get_sym(p5b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h3b),z->get_range(h4b),z->get_range(p5b),z->get_range(q6b),1,0,3,2,+1.0,false); 
          ...
          if (z->get_spin(h5b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
           if ((z->get_sym(h5b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             kn[3]->get_block(p6b_1-z->noab()+z->nvab()*(h5b_1+z->noab()*(h4b_1+z->noab()*(h3b_1))),k_a1); 
  ...
  for (long h1b=0L;h1b<z->noab();++h1b) { 
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    ...
    if (out->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_y()^z->irrep_v())) { 
        long dimc=z->get_range(h3b)*z->get_range(h4b)*z->get_range(h1b)*z->get_range(h2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
         if (z->get_spin(h3b)==z->get_spin(p5b)) { 
          if ((z->get_sym(h3b)^z->get_sym(p5b))==z->irrep_y()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(p5b),z->get_range(h1b),z->get_range(h2b),3,2,0,1,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        if (h3b>=h4b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h2b),z->get_range(h1b),z->get_range(h4b),z->get_range(h3b),2,3,1,0,-1.0,false); 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h4b)+z->get_spin(p5b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h4b)+z->get_spin(p5b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p5b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[0]->get_block(h2b_0+z->noab()*(h1b_0+z->noab()*(p5b_0-z->noab()+z->nvab()*(h4b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(p5b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h4b),z->get_range(p5b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
...
void CCSD_SUB_R12_LEFT::smith_0_2_1(){ 
...
void CCSD_SUB_R12_LEFT::smith_0_2_2(){ 
      ...
      if (z->get_spin(h4b)+z->get_spin(p5b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p5b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[4]->get_block(h2b_0+z->noab()*(h1b_0+z->noab()*(p5b_0-z->noab()+z->nvab()*(h4b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(p5b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h4b),z->get_range(p5b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,-1.0,false); 
          ...
          if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h5b)+z->get_spin(q6b)) { 
           if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h5b)^z->get_sym(q6b))))==z->irrep_v()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(h4b),z->get_range(h5b),z->get_range(q6b),1,0,3,2,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             kn[1]->get_block(h2b_1+z->noab()*(h1b_1+z->noab()*(q6b_1-z->noab()-z->nvab()+z->ncab()*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(q6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
             z->mem()->free_local_double(k_a1_sort); 
  ...
  for (long h1b=0L;h1b<z->noab();++h1b) { 
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    ...
    if (out->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_v()^(z->irrep_t()^z->irrep_v()))) { 
        long dimc=z->get_range(h3b)*z->get_range(h4b)*z->get_range(h1b)*z->get_range(h2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
          ...
          if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(p5b)+z->get_spin(p6b)) { 
           if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(p5b)^z->get_sym(p6b))))==z->irrep_y()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(p5b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (p5b==p6b) { 
              factor=factor/2.0; 
      ...
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_f())) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(p5b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
     ...
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(p5b)+z->get_spin(q6b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(p5b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(p5b)^z->get_sym(q6b))))==(z->irrep_y()^z->irrep_v())) { 
           ...
           if ((z->get_sym(h3b)^(z->get_sym(h7b)^(z->get_sym(p5b)^z->get_sym(p8b))))==z->irrep_y()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h3b<h7b && p5b<p8b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(h7b),z->get_range(p5b),z->get_range(p8b),2,0,3,1,+1.0,false); 
             } 
             else if (h3b<h7b && p8b<=p5b) { 
              z->lambda2()->get_block(p5b_0-z->noab()+z->nvab()*(p8b_0-z->noab()+z->nvab()*(h7b_0+z->noab()*(h3b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(h7b),z->get_range(p8b),z->get_range(p5b),3,0,2,1,-1.0,false); 
             } 
             else if (h7b<=h3b && p5b<p8b) { 
              z->lambda2()->get_block(p8b_0-z->noab()+z->nvab()*(p5b_0-z->noab()+z->nvab()*(h3b_0+z->noab()*(h7b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h3b),z->get_range(p5b),z->get_range(p8b),2,1,3,0,-1.0,false); 
             } 
             else if (h7b<=h3b && p8b<=p5b) { 
              z->lambda2()->get_block(p5b_0-z->noab()+z->nvab()*(p8b_0-z->noab()+z->nvab()*(h3b_0+z->noab()*(h7b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h3b),z->get_range(p8b),z->get_range(p5b),3,1,2,0,+1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             in[2]->get_block(q6b_1-z->noab()-z->nvab()+z->ncab()*(h7b_1+z->noab()*(p8b_1-z->noab()+z->nvab()*(h4b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(p8b),z->get_range(h7b),z->get_range(q6b),3,0,1,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
             z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (h4b>=h3b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(q6b),z->get_range(h4b),z->get_range(p5b),z->get_range(h3b),3,1,2,0,+1.0,false); 
         in[1]->add_block(q6b-z->noab()-z->nvab()+z->ncab()*(p5b-z->noab()+z->nvab()*(h4b+z->noab()*(h3b))),k_c); 
        } 
        if (h3b>=h4b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(q6b),z->get_range(h4b),z->get_range(p5b),z->get_range(h3b),1,3,2,0,-1.0,false); 
      ...
      if (z->get_spin(h4b)+z->get_spin(p8b)==z->get_spin(h7b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p8b)^(z->get_sym(h7b)^z->get_sym(q6b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(p8b),z->get_range(h7b),z->get_range(q6b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h4b),z->get_range(p8b),z->get_range(h7b),z->get_range(q6b),0,1,2,3,-1.0,false); 
  ...
  for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
   for (long q6b=z->noab()+z->nvab();q6b<z->nab();++q6b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(p5b)+z->get_spin(q6b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(p5b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(p5b)^z->get_sym(q6b))))==(z->irrep_v()^z->irrep_v())) { 
        long dimc=z->get_range(h3b)*z->get_range(h4b)*z->get_range(p5b)*z->get_range(q6b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h7b=0L;h7b<z->noab();++h7b) { 
           ...
           if ((z->get_sym(h3b)^(z->get_sym(h7b)^(z->get_sym(h8b)^z->get_sym(q6b))))==z->irrep_v()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h3b<h7b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(h7b),z->get_range(h8b),z->get_range(q6b),3,0,2,1,+1.0,false); 
             } 
             else if (h7b<=h3b) { 
              z->v2()->get_block(q6b_0+(z->nab())*(h8b_0+(z->nab())*(h3b_0+(z->nab())*(h7b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h3b),z->get_range(h8b),z->get_range(q6b),3,1,2,0,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h4b<h8b) { 
              kn[3]->get_block(p5b_1-z->noab()+z->nvab()*(h7b_1+z->noab()*(h8b_1+z->noab()*(h4b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(h8b),z->get_range(h7b),z->get_range(p5b),3,0,1,2,+1.0,false); 
             } 
             else if (h8b<=h4b) { 
              kn[3]->get_block(p5b_1-z->noab()+z->nvab()*(h7b_1+z->noab()*(h4b_1+z->noab()*(h8b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h4b),z->get_range(h7b),z->get_range(p5b),3,1,0,2,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (h4b>=h3b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(p5b),z->get_range(h4b),z->get_range(q6b),z->get_range(h3b),3,1,0,2,-1.0,false); 
         in[1]->add_block(q6b-z->noab()-z->nvab()+z->ncab()*(p5b-z->noab()+z->nvab()*(h4b+z->noab()*(h3b))),k_c); 
        } 
        if (h3b>=h4b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(p5b),z->get_range(h4b),z->get_range(q6b),z->get_range(h3b),1,3,0,2,+1.0,false); 
         in[1]->add_block(q6b-z->noab()-z->nvab()+z->ncab()*(p5b-z->noab()+z->nvab()*(h3b+z->noab()*(h4b))),k_c); 
        } 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
  ...
  for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
   for (long q6b=z->noab()+z->nvab();q6b<z->nab();++q6b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(p5b)+z->get_spin(q6b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(p5b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(p5b)^z->get_sym(q6b))))==(z->irrep_v()^(z->irrep_t()^z->irrep_v()))) { 
        long dimc=z->get_range(h3b)*z->get_range(h4b)*z->get_range(p5b)*z->get_range(q6b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h7b=0L;h7b<z->noab();++h7b) { 
           ...
           if ((z->get_sym(h3b)^(z->get_sym(h7b)^(z->get_sym(p8b)^z->get_sym(q6b))))==z->irrep_v()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h3b<h7b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(h7b),z->get_range(p8b),z->get_range(q6b),3,0,2,1,+1.0,false); 
             } 
             else if (h7b<=h3b) { 
              z->v2()->get_block(q6b_0+(z->nab())*(p8b_0+(z->nab())*(h3b_0+(z->nab())*(h7b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h3b),z->get_range(p8b),z->get_range(q6b),3,1,2,0,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             in[2]->get_block(p5b_1-z->noab()+z->nvab()*(h7b_1+z->noab()*(p8b_1-z->noab()+z->nvab()*(h4b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(p8b),z->get_range(h7b),z->get_range(p5b),3,0,1,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
             z->mem()->free_local_double(k_a1_sort); 
  ...
  for (long h7b=0L;h7b<z->noab();++h7b) { 
   for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
    if (z->get_spin(h4b)+z->get_spin(p8b)==z->get_spin(h7b)+z->get_spin(p5b)) { 
     if ((z->get_sym(h4b)^(z->get_sym(p8b)^(z->get_sym(h7b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p7b)==z->get_spin(h5b)) { 
          if ((z->get_sym(p7b)^z->get_sym(h5b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[3]->get_block(p7b_1-z->noab()+z->nvab()*(h6b_1+z->noab()*(h4b_1+z->noab()*(h3b_1))),k_a1); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(q6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(q6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^(z->irrep_t()^z->irrep_y()))) { 
         ...
         if (z->get_spin(p7b)+z->get_spin(q6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
          if ((z->get_sym(p7b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p7b),z->get_range(q6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            in[2]->get_block(p7b_1-z->noab()+z->nvab()*(p5b_1-z->noab()),k_a1); 
            z->sort_indices2(k_a1,k_a1_sort,z->get_range(p5b),z->get_range(p7b),0,1,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p5b),z->get_range(h2b),z->get_range(h1b),z->get_range(q6b),0,3,2,1,+1.0,false); 
         ...
         if (z->get_spin(p5b)==z->get_spin(h7b)) { 
          if ((z->get_sym(p5b)^z->get_sym(h7b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[1]->get_block(h2b_1+z->noab()*(h1b_1+z->noab()*(q6b_1-z->noab()-z->nvab()+z->ncab()*(h7b_1))),k_a1); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_f())) { 
         ...
         if (z->get_spin(p5b)+z->get_spin(q7b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
          if ((z->get_sym(p5b)^(z->get_sym(q7b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q7b),z->get_range(h1b),z->get_range(h2b),3,2,0,1,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            in[2]->get_block(q7b_1-z->noab()-z->nvab()+z->ncab()*(p6b_1-z->noab()),k_a1); 
            z->sort_indices2(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(q7b),0,1,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (p6b>=p5b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(p6b),z->get_range(h2b),z->get_range(h1b),z->get_range(p5b),3,0,2,1,+1.0,false); 
         in[1]->add_block(h2b+z->noab()*(h1b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(p6b),z->get_range(h2b),z->get_range(h1b),z->get_range(p5b),0,3,2,1,-1.0,false); 
    ...
    if (z->get_spin(p6b)==z->get_spin(q7b)) { 
     if ((z->get_sym(p6b)^z->get_sym(q7b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q7b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(p6b),z->get_range(q7b),0,1,+1.0,false); 
  ...
  for (long h1b=0L;h1b<z->noab();++h1b) { 
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^z->irrep_v())) { 
        long dimc=z->get_range(p5b)*z->get_range(p6b)*z->get_range(h1b)*z->get_range(h2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h7b=0L;h7b<z->noab();++h7b) { 
         if (z->get_spin(p5b)==z->get_spin(h7b)) { 
          if ((z->get_sym(p5b)^z->get_sym(h7b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (p6b>=p5b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h2b),z->get_range(h1b),z->get_range(p6b),z->get_range(p5b),3,2,1,0,+1.0,false); 
         in[1]->add_block(h2b+z->noab()*(h1b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h2b),z->get_range(h1b),z->get_range(p6b),z->get_range(p5b),2,3,1,0,-1.0,false); 
         in[1]->add_block(h2b+z->noab()*(h1b+z->noab()*(p5b-z->noab()+z->nvab()*(p6b-z->noab()))),k_c); 
        } 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
...
void CCSD_SUB_R12_LEFT::smith_1_9_0(){ 
  ...
  for (long h1b=0L;h1b<z->noab();++h1b) { 
   for (long h2b=h1b;h2b<z->noab();++h2b) { 
    ...
    if (in[2]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h7b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h7b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_v()) { 
        long dimc=z->get_range(h7b)*z->get_range(p6b)*z->get_range(h1b)*z->get_range(h2b); 
        long h7b_0,p6b_0,h1b_0,h2b_0; 
        z->restricted_4(h7b,p6b,h1b,h2b,h7b_0,p6b_0,h1b_0,h2b_0); 
        long dim_common=1L; 
        long dima0_sort=z->get_range(h7b)*z->get_range(p6b)*z->get_range(h1b)*z->get_range(h2b); 
        long dima0=dim_common*dima0_sort; 
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[0]->get_block(h2b_0+z->noab()*(h1b_0+z->noab()*(p6b_0-z->noab()+z->nvab()*(h7b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h7b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
...
void CCSD_SUB_R12_LEFT::smith_1_9_1(){ 
      ...
      if (z->get_spin(h7b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[4]->get_block(h2b_0+z->noab()*(h1b_0+z->noab()*(p6b_0-z->noab()+z->nvab()*(h7b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h7b),z->get_range(p6b),z->get_range(h1b),z->get_range(h2b),0,1,2,3,-1.0,false); 
   ...
   if (!z->restricted() || z->get_spin(p6b)+z->get_spin(q7b)!=4L) { 
    if (z->get_spin(p6b)==z->get_spin(q7b)) { 
     if ((z->get_sym(p6b)^z->get_sym(q7b))==(z->irrep_t()^z->irrep_v())) { 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q7b),z->get_range(p6b),1,0,+1.0,false); 
      in[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(p6b-z->noab()),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
     ...
     if (!z->restricted() || z->get_spin(h4b)+z->get_spin(p8b)+z->get_spin(h7b)+z->get_spin(q6b)!=8L) { 
      if (z->get_spin(h4b)+z->get_spin(p8b)==z->get_spin(h7b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p8b)^(z->get_sym(h7b)^z->get_sym(q6b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p9b)==z->get_spin(h7b)) { 
          if ((z->get_sym(p9b)^z->get_sym(h7b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(p8b),z->get_range(p9b),z->get_range(q6b),3,1,0,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q6b),z->get_range(p8b),z->get_range(h4b),z->get_range(h7b),2,1,3,0,-1.0,false); 
        in[2]->add_block(q6b-z->noab()-z->nvab()+z->ncab()*(h7b+z->noab()*(p8b-z->noab()+z->nvab()*(h4b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(h4b)+z->get_spin(p8b)+z->get_spin(h7b)+z->get_spin(p5b)!=8L) { 
      if (z->get_spin(h4b)+z->get_spin(p8b)==z->get_spin(h7b)+z->get_spin(p5b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p8b)^(z->get_sym(h7b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p8b)==z->get_spin(h9b)) { 
          if ((z->get_sym(p8b)^z->get_sym(h9b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h4b<h9b) { 
             kn[3]->get_block(p5b_1-z->noab()+z->nvab()*(h7b_1+z->noab()*(h9b_1+z->noab()*(h4b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(h9b),z->get_range(h7b),z->get_range(p5b),3,2,0,1,+1.0,false); 
            } 
            else if (h9b<=h4b) { 
             kn[3]->get_block(p5b_1-z->noab()+z->nvab()*(h7b_1+z->noab()*(h4b_1+z->noab()*(h9b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h9b),z->get_range(h4b),z->get_range(h7b),z->get_range(p5b),3,2,1,0,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p5b),z->get_range(h7b),z->get_range(h4b),z->get_range(p8b),2,3,1,0,-1.0,false); 
   ...
   if (!z->restricted() || z->get_spin(p6b)+z->get_spin(q7b)!=4L) { 
    if (z->get_spin(p6b)==z->get_spin(q7b)) { 
     if ((z->get_sym(p6b)^z->get_sym(q7b))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p6b)+z->get_spin(p8b)==z->get_spin(h9b)+z->get_spin(h10b)) { 
          if ((z->get_sym(p6b)^(z->get_sym(p8b)^(z->get_sym(h9b)^z->get_sym(h10b))))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h9b),z->get_range(h10b),z->get_range(p8b),z->get_range(q7b),3,2,1,0,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            if (h9b==h10b) { 
             factor=factor/2.0; 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q7b),z->get_range(p6b),1,0,+0.5/0.5,false); 
      in[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(p6b-z->noab()),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
     ...
     if (!z->restricted() || z->get_spin(h4b)+z->get_spin(p8b)+z->get_spin(h7b)+z->get_spin(p5b)!=8L) { 
      if (z->get_spin(h4b)+z->get_spin(p8b)==z->get_spin(h7b)+z->get_spin(p5b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p8b)^(z->get_sym(h7b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_y())) { 
           ...
           if ((z->get_sym(p8b)^(z->get_sym(p9b)^(z->get_sym(h7b)^z->get_sym(h10b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (p8b<p9b && h7b<h10b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p8b),z->get_range(p9b),z->get_range(h7b),z->get_range(h10b),2,0,1,3,+1.0,false); 
             } 
             else if (p8b<p9b && h10b<=h7b) { 
              z->t2()->get_block(h7b_0+z->noab()*(h10b_0+z->noab()*(p9b_0-z->noab()+z->nvab()*(p8b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p8b),z->get_range(p9b),z->get_range(h10b),z->get_range(h7b),3,0,1,2,-1.0,false); 
             } 
             else if (p9b<=p8b && h7b<h10b) { 
              z->t2()->get_block(h10b_0+z->noab()*(h7b_0+z->noab()*(p8b_0-z->noab()+z->nvab()*(p9b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p9b),z->get_range(p8b),z->get_range(h7b),z->get_range(h10b),2,1,0,3,-1.0,false); 
             } 
             else if (p9b<=p8b && h10b<=h7b) { 
              z->t2()->get_block(h7b_0+z->noab()*(h10b_0+z->noab()*(p8b_0-z->noab()+z->nvab()*(p9b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p9b),z->get_range(p8b),z->get_range(h10b),z->get_range(h7b),3,1,0,2,+1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h4b<h10b && p5b<p9b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(h10b),z->get_range(p5b),z->get_range(p9b),2,0,3,1,+1.0,false); 
             } 
             else if (h4b<h10b && p9b<=p5b) { 
              z->lambda2()->get_block(p5b_1-z->noab()+z->nvab()*(p9b_1-z->noab()+z->nvab()*(h10b_1+z->noab()*(h4b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(h10b),z->get_range(p9b),z->get_range(p5b),3,0,2,1,-1.0,false); 
             } 
             else if (h10b<=h4b && p5b<p9b) { 
              z->lambda2()->get_block(p9b_1-z->noab()+z->nvab()*(p5b_1-z->noab()+z->nvab()*(h4b_1+z->noab()*(h10b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h10b),z->get_range(h4b),z->get_range(p5b),z->get_range(p9b),2,1,3,0,-1.0,false); 
             } 
             else if (h10b<=h4b && p9b<=p5b) { 
              z->lambda2()->get_block(p5b_1-z->noab()+z->nvab()*(p9b_1-z->noab()+z->nvab()*(h4b_1+z->noab()*(h10b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h10b),z->get_range(h4b),z->get_range(p9b),z->get_range(p5b),3,1,2,0,+1.0,false); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p5b),z->get_range(h4b),z->get_range(h7b),z->get_range(p8b),1,3,2,0,+1.0,false); 
        in[2]->add_block(p5b-z->noab()+z->nvab()*(h7b+z->noab()*(p8b-z->noab()+z->nvab()*(h4b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
   ...
   if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p7b)!=4L) { 
    if (z->get_spin(p5b)==z->get_spin(p7b)) { 
     if ((z->get_sym(p5b)^z->get_sym(p7b))==(z->irrep_t()^z->irrep_y())) { 
          ...
          if ((z->get_sym(p5b)^(z->get_sym(p8b)^(z->get_sym(h9b)^z->get_sym(h10b))))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (p5b<p8b) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(p8b),z->get_range(h9b),z->get_range(h10b),0,1,3,2,+1.0,false); 
            } 
            else if (p8b<=p5b) { 
             z->t2()->get_block(h10b_0+z->noab()*(h9b_0+z->noab()*(p5b_0-z->noab()+z->nvab()*(p8b_0-z->noab()))),k_a0); 
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(p8b),z->get_range(p5b),z->get_range(h9b),z->get_range(h10b),1,0,3,2,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(p7b),z->get_range(p5b),1,0,-0.5/0.5,false); 
...
void CCSD_SUB_R12_LEFT::smith_k0(){ 
     ...
     if (!z->restricted() || z->get_spin(h7b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h7b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_f())) { 
         ...
         if (z->get_spin(p6b)+z->get_spin(q8b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
          if ((z->get_sym(p6b)^(z->get_sym(q8b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q8b),z->get_range(h1b),z->get_range(h2b),3,2,0,1,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            z->f1()->get_block(q8b_1+(z->nab())*(h7b_1),k_a1); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h7b),z->get_range(h2b),z->get_range(h1b),z->get_range(p6b),0,3,2,1,+1.0,false); 
        kn[0]->add_block(h2b+z->noab()*(h1b+z->noab()*(p6b-z->noab()+z->nvab()*(h7b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void CCSD_SUB_R12_LEFT::smith_k1(){ 
     ...
     if (!z->restricted() || z->get_spin(h7b)+z->get_spin(q6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h7b)+z->get_spin(q6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(q6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_y()^z->irrep_e())) { 
         ...
         if (z->get_spin(h7b)==z->get_spin(p8b)) { 
          if ((z->get_sym(h7b)^z->get_sym(p8b))==z->irrep_y()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p8b),z->get_range(q6b),z->get_range(h1b),z->get_range(h2b),3,2,1,0,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h2b),z->get_range(h1b),z->get_range(q6b),z->get_range(h7b),3,2,1,0,+1.0,false); 
        kn[1]->add_block(h2b+z->noab()*(h1b+z->noab()*(q6b-z->noab()-z->nvab()+z->ncab()*(h7b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void CCSD_SUB_R12_LEFT::smith_k2(){ 
   ...
   if (!z->restricted() || z->get_spin(h7b)+z->get_spin(q8b)!=4L) { 
    if (z->get_spin(h7b)==z->get_spin(q8b)) { 
     if ((z->get_sym(h7b)^z->get_sym(q8b))==(z->irrep_t()^z->irrep_v())) { 
      ...
      kn[2]->add_block(q8b-z->noab()-z->nvab()+z->ncab()*(h7b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
    } 
...
void CCSD_SUB_R12_LEFT::smith_k3(){ 
     ...
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(h6b)+z->get_spin(p7b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h6b)+z->get_spin(p7b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h6b)^z->get_sym(p7b))))==(z->irrep_t()^z->irrep_y())) { 
        ...
        kn[3]->add_block(p7b-z->noab()+z->nvab()*(h6b+z->noab()*(h4b+z->noab()*(h3b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void CCSD_SUB_R12_LEFT::smith_k4(){ 
     ...
     if (!z->restricted() || z->get_spin(h7b)+z->get_spin(p6b)+z->get_spin(h1b)+z->get_spin(h2b)!=8L) { 
      if (z->get_spin(h7b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(p6b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_e()^z->irrep_v())) { 
         ...
         if (z->get_spin(p6b)+z->get_spin(q8b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
          if ((z->get_sym(p6b)^(z->get_sym(q8b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[2]->get_block(q8b_1-z->noab()-z->nvab()+z->ncab()*(h7b_1),k_a1); 
            z->sort_indices2(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(q8b),0,1,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h7b),z->get_range(h2b),z->get_range(h1b),z->get_range(p6b),0,3,2,1,+1.0,false); 
        kn[4]->add_block(h2b+z->noab()*(h1b+z->noab()*(p6b-z->noab()+z->nvab()*(h7b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
