...
kn.at(0)=new Tensor("ccsdpr12_t2_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
kn.at(1)=new Tensor("ccsdpr12_t2_k1",z->mem());
offset_k1();
smith_k1(); //z->t1(),z->v2()=>kn.at(1)
kn.at(2)=new Tensor("ccsdpr12_t2_k2",z->mem());
offset_k2();
smith_k2(); //z->t1(),z->v2()=>kn.at(2)
kn.at(3)=new Tensor("ccsdpr12_t2_k3",z->mem());
offset_k3();
smith_k3(); //z->gt2(),z->vr2()=>kn.at(3)
kn.at(4)=new Tensor("ccsdpr12_t2_k4",z->mem());
offset_k4();
smith_k4(); //z->t2(),z->v2()=>kn.at(4)
kn.at(5)=new Tensor("ccsdpr12_t2_k5",z->mem());
offset_k5();
smith_k5(); //z->t1(),z->v2()=>kn.at(5)
kn.at(6)=new Tensor("ccsdpr12_t2_k6",z->mem());
offset_k6();
...
smith_1_34(); //z->t1(),kn.at(5)=>in.at(1)
...
smith_1_7_1(); //kn.at(0)=>in.at(2)
smith_1_7_2(); //kn.at(6)=>in.at(2)
smith_1_7_3(); //kn.at(3)=>in.at(2)
smith_1_7_4(); //kn.at(4)=>in.at(2)
smith_1_7(); //z->t1(),in.at(2)=>in.at(1)
delete in.at(2);
in.at(2)=new Tensor("ccsdpr12_t2_2_1",z->mem());
offset_smith_1_8();
smith_1_8_0(); //z->v2()=>in.at(2)
smith_1_8_1(); //kn.at(1)=>in.at(2)
...
delete in.at(2);
smith_1_35(); //z->t2(),kn.at(5)=>in.at(1)
...
smith_0_10_1(); //kn.at(0)=>in.at(1)
smith_0_10_2(); //kn.at(6)=>in.at(1)
smith_0_10_3(); //kn.at(4)=>in.at(1)
smith_0_10_4(); //kn.at(3)=>in.at(1)
smith_0_10(out); //z->t2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsdpr12_t2_1_6",z->mem());
offset_smith_0_11();
smith_0_11_0(); //z->v2()=>in.at(1)
smith_0_11_1(); //kn.at(1)=>in.at(1)
       ...
       if (z->get_spin(p6b)==z->get_spin(h2b)) { 
        if ((z->get_sym(p6b)^z->get_sym(h2b))==z->irrep_t()) { 
         ...
         if (dima0>0L && dima1>0L) { 
          ...
          double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
          double* k_a1=z->mem()->malloc_local_double(dima1); 
          kn[5]->get_block(p6b_1-z->noab()+z->nvab()*(h5b_1),k_a1); 
