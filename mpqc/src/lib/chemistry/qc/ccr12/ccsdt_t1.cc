...
kn.at(0)=new Tensor("ccsdt_t1_k0",z->mem());
offset_k0();
   ...
   if (!z->restricted() || z->get_spin(p2b)+z->get_spin(h1b)!=4L) { 
    if (z->get_spin(p2b)==z->get_spin(h1b)) { 
     if ((z->get_sym(p2b)^z->get_sym(h1b))==(z->irrep_t()^z->irrep_v())) { 
           ...
           if ((z->get_sym(p2b)^(z->get_sym(p3b)^(z->get_sym(p4b)^(z->get_sym(h1b)^(z->get_sym(h5b)^z->get_sym(h6b))))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (p2b<p3b && h1b<h5b) { 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p2b),z->get_range(p3b),z->get_range(p4b),z->get_range(h1b),z->get_range(h5b),z->get_range(h6b),3,0,2,1,5,4,+1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p2b),z->get_range(p3b),z->get_range(p4b),z->get_range(h5b),z->get_range(h1b),z->get_range(h6b),4,0,2,1,5,3,-1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p2b),z->get_range(p3b),z->get_range(p4b),z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),5,0,2,1,4,3,+1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p3b),z->get_range(p2b),z->get_range(p4b),z->get_range(h1b),z->get_range(h5b),z->get_range(h6b),3,1,2,0,5,4,-1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p3b),z->get_range(p2b),z->get_range(p4b),z->get_range(h5b),z->get_range(h1b),z->get_range(h6b),4,1,2,0,5,3,+1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p3b),z->get_range(p2b),z->get_range(p4b),z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),5,1,2,0,4,3,-1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p3b),z->get_range(p4b),z->get_range(p2b),z->get_range(h1b),z->get_range(h5b),z->get_range(h6b),3,2,1,0,5,4,+1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p3b),z->get_range(p4b),z->get_range(p2b),z->get_range(h5b),z->get_range(h1b),z->get_range(h6b),4,2,1,0,5,3,-1.0,false); 
             } 
              ...
              z->sort_indices6(k_a0,k_a0_sort,z->get_range(p3b),z->get_range(p4b),z->get_range(p2b),z->get_range(h5b),z->get_range(h6b),z->get_range(h1b),5,2,1,0,4,3,+1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->v2()->get_block(p4b_1+(z->nab())*(p3b_1+(z->nab())*(h6b_1+(z->nab())*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p3b),z->get_range(p4b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h5b==h6b) { 
              factor=factor/2.0; 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(h1b),z->get_range(p2b),1,0,+0.25/0.25,false); 
      out->add_block(h1b+z->noab()*(p2b-z->noab()),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
