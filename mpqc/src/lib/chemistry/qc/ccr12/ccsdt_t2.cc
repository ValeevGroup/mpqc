...
kn.at(0)=new Tensor("ccsdt_t2_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
kn.at(1)=new Tensor("ccsdt_t2_k1",z->mem());
offset_k1();
smith_k1(); //z->t1(),z->v2()=>kn.at(1)
kn.at(2)=new Tensor("ccsdt_t2_k2",z->mem());
offset_k2();
smith_k2(); //z->t1(),z->v2()=>kn.at(2)
kn.at(3)=new Tensor("ccsdt_t2_k3",z->mem());
offset_k3();
smith_k3(); //z->t1(),z->v2()=>kn.at(3)
kn.at(4)=new Tensor("ccsdt_t2_k4",z->mem());
offset_k4();
smith_k4(); //z->t2(),z->v2()=>kn.at(4)
kn.at(5)=new Tensor("ccsdt_t2_k5",z->mem());
offset_k5();
