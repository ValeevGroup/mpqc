...
CCSDTQ_T2::CCSDTQ_T2(CCR12_Info* info):z(info){};
CCSDTQ_T2::~CCSDTQ_T2(){};
  
  
  
void CCSDTQ_T2::compute_amp(Ref<Tensor>& out){ //k_i0_offset,z->f1(),z->in.at(0),z->t1(),z->t2(),z->t3(),z->t4()=>z->v2()
  
in.resize(8);
kn.resize(64);
  
kn.at(0)=new Tensor("ccsdtq_t2_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
kn.at(1)=new Tensor("ccsdtq_t2_k1",z->mem());
offset_k1();
smith_k1(); //z->t1(),z->v2()=>kn.at(1)
kn.at(2)=new Tensor("ccsdtq_t2_k2",z->mem());
offset_k2();
smith_k2(); //z->t1(),z->v2()=>kn.at(2)
kn.at(3)=new Tensor("ccsdtq_t2_k3",z->mem());
offset_k3();
smith_k3(); //z->t1(),z->v2()=>kn.at(3)
kn.at(4)=new Tensor("ccsdtq_t2_k4",z->mem());
offset_k4();
smith_k4(); //z->t2(),z->v2()=>kn.at(4)
kn.at(5)=new Tensor("ccsdtq_t2_k5",z->mem());
offset_k5();
smith_k5(); //z->t1(),kn.at(2)=>kn.at(5)
in.at(1)=new Tensor("ccsdtq_t2_1_0",z->mem());
offset_smith_0_1();
smith_0_1_0(); //z->f1()=>in.at(1)
in.at(2)=new Tensor("ccsdtq_t2_2_0",z->mem());
offset_smith_1_3();
...
delete in.at(1);
in.at(1)=new Tensor("ccsdtq_t2_1_1",z->mem());
offset_smith_0_2();
smith_0_2_0(); //z->f1()=>in.at(1)
smith_1_19(); //z->t1(),z->v2()=>in.at(1)
smith_1_35(); //z->t2(),z->v2()=>in.at(1)
smith_0_2(out); //z->t2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("ccsdtq_t2_1_2",z->mem());
offset_smith_0_4();
...
in.at(1)=new Tensor("ccsdtq_t2_1_7",z->mem());
offset_smith_0_23();
smith_0_23_0(); //z->v2()=>in.at(1)
smith_0_23_1(); //kn.at(2)=>in.at(1)
smith_0_23(out); //z->t3(),in.at(1)=>out
delete in.at(1);
smith_0_24(out); //z->t3(),z->v2()=>out
smith_0_38(out); //z->t4(),z->v2()=>out
delete kn.at(5);
delete kn.at(4);
delete kn.at(3);
delete kn.at(2);
    ...
    if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h2b)+z->get_spin(p5b)) { 
     if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h2b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_v())) { 
      if (!z->restricted() || z->get_spin(h6b)+z->get_spin(h7b)+z->get_spin(h2b)+z->get_spin(p5b)!=8L) { 
       kn[2]->input_offset(p5b-z->noab()+z->nvab()*(h2b+z->noab()*(h7b+z->noab()*(h6b))),size); 
  ...
  if (z->get_spin(h6b)==z->get_spin(p5b)) { 
   if ((z->get_sym(h6b)^z->get_sym(p5b))==(z->irrep_t()^z->irrep_v())) { 
    if (!z->restricted() || z->get_spin(h6b)+z->get_spin(p5b)!=4L) { 
     kn[3]->input_offset(p5b-z->noab()+z->nvab()*(h6b),size); 
...
void CCSDTQ_T2::smith_0_1(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::smith_0_12(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::offset_smith_0_12(){ 
...
void CCSDTQ_T2::smith_0_13(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::offset_smith_0_13(){ 
...
void CCSDTQ_T2::smith_0_14(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::offset_smith_0_1(){ 
...
void CCSDTQ_T2::smith_0_2(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::smith_0_23(Ref<Tensor>& out){ 
      ...
      if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h2b)+z->get_spin(p5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h2b)^z->get_sym(p5b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[2]->get_block(p5b_0-z->noab()+z->nvab()*(h2b_0+z->noab()*(h7b_0+z->noab()*(h6b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h7b),z->get_range(h2b),z->get_range(p5b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h6b),z->get_range(h7b),z->get_range(h2b),z->get_range(p5b),0,1,2,3,+1.0,false); 
...
void CCSDTQ_T2::offset_smith_0_23(){ 
...
void CCSDTQ_T2::smith_0_24(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::offset_smith_0_2(){ 
...
void CCSDTQ_T2::smith_0_38(Ref<Tensor>& out){ 
       ...
       if ((z->get_sym(p3b)^(z->get_sym(p4b)^(z->get_sym(h1b)^z->get_sym(h2b))))==(z->irrep_t()^z->irrep_v())) { 
        ...
        for (long h7b=0L;h7b<z->noab();++h7b) { 
         for (long h8b=h7b;h8b<z->noab();++h8b) { 
          for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
           for (long p6b=p5b;p6b<z->noab()+z->nvab();++p6b) { 
            if (z->get_spin(p3b)+z->get_spin(p4b)+z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h1b)+z->get_spin(h2b)+z->get_spin(h7b)+z->get_spin(h8b)) { 
             if ((z->get_sym(p3b)^(z->get_sym(p4b)^(z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h1b)^(z->get_sym(h2b)^(z->get_sym(h7b)^z->get_sym(h8b))))))))==z->irrep_t()) { 
              long p3b_0,p4b_0,p5b_0,p6b_0,h1b_0,h2b_0,h7b_0,h8b_0; 
              z->restricted_8(p3b,p4b,p5b,p6b,h1b,h2b,h7b,h8b,p3b_0,p4b_0,p5b_0,p6b_0,h1b_0,h2b_0,h7b_0,h8b_0); 
              long h7b_1,h8b_1,p5b_1,p6b_1; 
              z->restricted_4(h7b,h8b,p5b,p6b,h7b_1,h8b_1,p5b_1,p6b_1); 
              long dim_common=z->get_range(h7b)*z->get_range(h8b)*z->get_range(p5b)*z->get_range(p6b); 
...
void CCSDTQ_T2::smith_0_4(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::offset_smith_0_4(){ 
...
void CCSDTQ_T2::smith_0_5(Ref<Tensor>& out){ 
    ...
    if (z->get_spin(h6b)==z->get_spin(p5b)) { 
     if ((z->get_sym(h6b)^z->get_sym(p5b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[3]->get_block(p5b_0-z->noab()+z->nvab()*(h6b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(p5b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h6b),z->get_range(p5b),0,1,+1.0,false); 
...
void CCSDTQ_T2::offset_smith_0_5(){ 
...
void CCSDTQ_T2::smith_0_6(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::smith_0_8(Ref<Tensor>& out){ 
...
void CCSDTQ_T2::offset_smith_0_8(){ 
...
void CCSDTQ_T2::offset_smith_1_10(){ 
...
void CCSDTQ_T2::offset_smith_1_20(){ 
...
void CCSDTQ_T2::offset_smith_1_3(){ 
...
void CCSDTQ_T2::offset_smith_1_4(){ 
...
void CCSDTQ_T2::offset_smith_1_9(){ 
     ...
     if (!z->restricted() || z->get_spin(h6b)+z->get_spin(h7b)+z->get_spin(h2b)+z->get_spin(p5b)!=8L) { 
      if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h2b)+z->get_spin(p5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h2b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_v())) { 
        ...
        kn[2]->add_block(p5b-z->noab()+z->nvab()*(h2b+z->noab()*(h7b+z->noab()*(h6b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
   ...
   if (!z->restricted() || z->get_spin(h6b)+z->get_spin(p5b)!=4L) { 
    if (z->get_spin(h6b)==z->get_spin(p5b)) { 
     if ((z->get_sym(h6b)^z->get_sym(p5b))==(z->irrep_t()^z->irrep_v())) { 
      ...
      kn[3]->add_block(p5b-z->noab()+z->nvab()*(h6b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
    } 
