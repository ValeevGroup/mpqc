...
kn.at(0)=new Tensor("lambda_ccsdpr12_t1_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
kn.at(1)=new Tensor("lambda_ccsdpr12_t1_k1",z->mem());
offset_k1();
smith_k1(); //z->t1(),z->lambda1()=>kn.at(1)
kn.at(2)=new Tensor("lambda_ccsdpr12_t1_k2",z->mem());
offset_k2();
smith_k2(); //z->t1(),z->lambda2()=>kn.at(2)
kn.at(3)=new Tensor("lambda_ccsdpr12_t1_k3",z->mem());
offset_k3();
smith_k3(); //z->t1(),z->ly()=>kn.at(3)
kn.at(4)=new Tensor("lambda_ccsdpr12_t1_k4",z->mem());
offset_k4();
smith_k4(); //z->t2(),z->lambda2()=>kn.at(4)
kn.at(5)=new Tensor("lambda_ccsdpr12_t1_k5",z->mem());
offset_k5();
smith_k5(); //z->t2(),z->lambda2()=>kn.at(5)
kn.at(6)=new Tensor("lambda_ccsdpr12_t1_k6",z->mem());
offset_k6();
smith_k6(); //z->t1(),z->v2()=>kn.at(6)
kn.at(7)=new Tensor("lambda_ccsdpr12_t1_k7",z->mem());
offset_k7();
smith_k7(); //z->t1(),kn.at(2)=>kn.at(7)
smith_0_1(out); //kn.at(0)=>out
in.at(1)=new Tensor("lambda_ccsdpr12_t1_1_0",z->mem());
offset_smith_0_2();
smith_0_2_0(); //z->f1()=>in.at(1)
smith_1_5(); //z->t1(),z->v2()=>in.at(1)
smith_1_9(); //z->t1(),kn.at(0)=>in.at(1)
...
offset_smith_0_7();
smith_0_7_0(); //kn.at(1)=>in.at(1)
smith_0_7_1(); //kn.at(5)=>in.at(1)
...
offset_smith_1_11();
smith_1_11_0(); //kn.at(1)=>in.at(2)
smith_1_11_1(); //kn.at(5)=>in.at(2)
smith_1_11(); //z->t1(),in.at(2)=>in.at(1)
delete in.at(2);
smith_1_14(); //z->t2(),z->lambda1()=>in.at(1)
smith_1_56(); //z->t2(),kn.at(2)=>in.at(1)
...
smith_1_52(); //z->t2(),kn.at(0)=>in.at(1)
...
offset_smith_0_31();
smith_0_31_0(); //kn.at(7)=>in.at(1)
smith_0_31_1(); //kn.at(4)=>in.at(1)
smith_0_31(out); //z->v2(),in.at(1)=>out
delete in.at(1);
in.at(1)=new Tensor("lambda_ccsdpr12_t1_1_11",z->mem());
offset_smith_0_32();
smith_1_32(); //z->t1(),kn.at(2)=>in.at(1)
...
offset_smith_0_44();
smith_1_44(); //z->t1(),kn.at(3)=>in.at(1)
...
void LAMBDA_CCSDPR12_T1::offset_k0(){ 
  ...
  if (z->get_spin(h2b)==z->get_spin(p6b)) { 
   if ((z->get_sym(h2b)^z->get_sym(p6b))==(z->irrep_t()^z->irrep_v())) { 
    if (!z->restricted() || z->get_spin(h2b)+z->get_spin(p6b)!=4L) { 
     kn[0]->input_offset(p6b-z->noab()+z->nvab()*(h2b),size); 
...
void LAMBDA_CCSDPR12_T1::offset_k1(){ 
  ...
  if (z->get_spin(h5b)==z->get_spin(h3b)) { 
   if ((z->get_sym(h5b)^z->get_sym(h3b))==(z->irrep_t()^z->irrep_y())) { 
    if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h3b)!=4L) { 
     kn[1]->input_offset(h3b+z->noab()*(h5b),size); 
...
void LAMBDA_CCSDPR12_T1::offset_k2(){ 
    ...
    if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h3b)+z->get_spin(p5b)) { 
     if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h3b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_y())) { 
      if (!z->restricted() || z->get_spin(h6b)+z->get_spin(h7b)+z->get_spin(h3b)+z->get_spin(p5b)!=8L) { 
       kn[2]->input_offset(p5b-z->noab()+z->nvab()*(h3b+z->noab()*(h7b+z->noab()*(h6b))),size); 
...
void LAMBDA_CCSDPR12_T1::offset_k3(){ 
    ...
    if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(q4b)) { 
     if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(q4b))))==(z->irrep_t()^z->irrep_y())) { 
      if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(q4b)!=8L) { 
       kn[3]->input_offset(q4b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(h6b+z->noab()*(h2b))),size); 
...
void LAMBDA_CCSDPR12_T1::offset_k4(){ 
    ...
    if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
     if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==(z->irrep_t()^z->irrep_y())) { 
      if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
       kn[4]->input_offset(h4b+z->noab()*(h3b+z->noab()*(h6b+z->noab()*(h2b))),size); 
...
void LAMBDA_CCSDPR12_T1::offset_k5(){ 
...
for (long h5b=0L;h5b<z->noab();++h5b) { 
 for (long h3b=0L;h3b<z->noab();++h3b) { 
  if (z->get_spin(h5b)==z->get_spin(h3b)) { 
   if ((z->get_sym(h5b)^z->get_sym(h3b))==(z->irrep_t()^z->irrep_y())) { 
    if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h3b)!=4L) { 
     kn[5]->input_offset(h3b+z->noab()*(h5b),size); 
     size+=z->get_range(h5b)*z->get_range(h3b); 
    } 
   } 
  } 
...
void LAMBDA_CCSDPR12_T1::offset_k6(){ 
    ...
    if (z->get_spin(h2b)+z->get_spin(h7b)==z->get_spin(h4b)+z->get_spin(p6b)) { 
     if ((z->get_sym(h2b)^(z->get_sym(h7b)^(z->get_sym(h4b)^z->get_sym(p6b))))==(z->irrep_t()^z->irrep_v())) { 
      if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h7b)+z->get_spin(h4b)+z->get_spin(p6b)!=8L) { 
       kn[6]->input_offset(p6b-z->noab()+z->nvab()*(h4b+z->noab()*(h7b+z->noab()*(h2b))),size); 
...
void LAMBDA_CCSDPR12_T1::offset_k7(){ 
   ...
   for (long h4b=h3b;h4b<z->noab();++h4b) { 
    if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
     if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==(z->irrep_t()^z->irrep_e())) { 
      if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
       kn[7]->input_offset(h4b+z->noab()*(h3b+z->noab()*(h6b+z->noab()*(h2b))),size); 
       size+=z->get_range(h2b)*z->get_range(h6b)*z->get_range(h3b)*z->get_range(h4b); 
      } 
     } 
    } 
  ...
  if (out->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h2b)+z->get_spin(p1b)!=4L) { 
    if (z->get_spin(h2b)==z->get_spin(p1b)) { 
     if ((z->get_sym(h2b)^z->get_sym(p1b))==z->irrep_e()) { 
      ...
      if (dima0>0L) { 
       ...
       kn[0]->get_block(p1b_0-z->noab()+z->nvab()*(h2b_0),k_a0); 
...
for (long h2b=0L;h2b<z->noab();++h2b) { 
 for (long p1b=z->noab();p1b<z->noab()+z->nvab();++p1b) { 
  ...
  if (out->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h2b)+z->get_spin(p1b)!=4L) { 
    if (z->get_spin(h2b)==z->get_spin(p1b)) { 
     if ((z->get_sym(h2b)^z->get_sym(p1b))==(z->irrep_v()^(z->irrep_t()^z->irrep_e()))) { 
      long dimc=z->get_range(h2b)*z->get_range(p1b); 
...
for (long p4b=z->noab();p4b<z->noab()+z->nvab();++p4b) { 
 for (long h3b=0L;h3b<z->noab();++h3b) { 
  if (z->get_spin(p4b)==z->get_spin(h3b)) { 
   if ((z->get_sym(p4b)^z->get_sym(h3b))==(z->irrep_t()^z->irrep_e())) { 
...
for (long h2b=0L;h2b<z->noab();++h2b) { 
 for (long p1b=z->noab();p1b<z->noab()+z->nvab();++p1b) { 
  ...
  if (out->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h2b)+z->get_spin(p1b)!=4L) { 
    if (z->get_spin(h2b)==z->get_spin(p1b)) { 
     if ((z->get_sym(h2b)^z->get_sym(p1b))==(z->irrep_v()^z->irrep_e())) { 
      long dimc=z->get_range(h2b)*z->get_range(p1b); 
      double* k_c_sort=z->mem()->malloc_local_double(dimc); 
      std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
      for (long h3b=0L;h3b<z->noab();++h3b) { 
         ...
         if (z->get_spin(h2b)+z->get_spin(h3b)==z->get_spin(h4b)+z->get_spin(h5b)) { 
          if ((z->get_sym(h2b)^(z->get_sym(h3b)^(z->get_sym(h4b)^z->get_sym(h5b))))==z->irrep_v()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[2]->get_block(p1b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h5b_1+z->noab()*(h4b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(h5b),z->get_range(h3b),z->get_range(p1b),3,1,0,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            if (h4b==h5b) { 
         ...
         if (z->get_spin(h3b)+z->get_spin(p4b)==z->get_spin(h5b)+z->get_spin(p1b)) { 
          if ((z->get_sym(h3b)^(z->get_sym(p4b)^(z->get_sym(h5b)^z->get_sym(p1b))))==z->irrep_v()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h2b<h5b) { 
             kn[2]->get_block(p4b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h5b_1+z->noab()*(h2b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h5b),z->get_range(h3b),z->get_range(p4b),0,3,1,2,+1.0,false); 
            } 
            else if (h5b<=h2b) { 
             kn[2]->get_block(p4b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h2b_1+z->noab()*(h5b_1))),k_a1); 
         ...
         if (z->get_spin(h3b)+z->get_spin(q4b)==z->get_spin(h5b)+z->get_spin(p1b)) { 
          if ((z->get_sym(h3b)^(z->get_sym(q4b)^(z->get_sym(h5b)^z->get_sym(p1b))))==z->irrep_v()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(h3b),z->get_range(q4b),z->get_range(h5b),z->get_range(p1b),3,1,2,0,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h2b<h5b) { 
             kn[3]->get_block(q4b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(h5b_1+z->noab()*(h2b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h5b),z->get_range(h3b),z->get_range(q4b),0,3,1,2,+1.0,false); 
            } 
            else if (h5b<=h2b) { 
             kn[3]->get_block(q4b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(h2b_1+z->noab()*(h5b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h2b),z->get_range(h3b),z->get_range(q4b),1,3,0,2,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
...
void LAMBDA_CCSDPR12_T1::smith_0_31_0(){ 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h5b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(h5b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h5b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_e()) { 
        long dimc=z->get_range(h2b)*z->get_range(h5b)*z->get_range(h3b)*z->get_range(h4b); 
        long h2b_0,h5b_0,h3b_0,h4b_0; 
        z->restricted_4(h2b,h5b,h3b,h4b,h2b_0,h5b_0,h3b_0,h4b_0); 
        long dim_common=1L; 
        long dima0_sort=z->get_range(h2b)*z->get_range(h5b)*z->get_range(h3b)*z->get_range(h4b); 
        long dima0=dim_common*dima0_sort; 
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[7]->get_block(h4b_0+z->noab()*(h3b_0+z->noab()*(h5b_0+z->noab()*(h2b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h5b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h5b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,-1.0,false); 
...
void LAMBDA_CCSDPR12_T1::smith_0_31_1(){ 
      ...
      if (z->get_spin(h2b)+z->get_spin(h5b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h5b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_e()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[4]->get_block(h4b_0+z->noab()*(h3b_0+z->noab()*(h5b_0+z->noab()*(h2b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h5b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h5b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,-1.0,false); 
  ...
  for (long h3b=0L;h3b<z->noab();++h3b) { 
   for (long p4b=z->noab();p4b<z->noab()+z->nvab();++p4b) { 
    if (z->get_spin(h2b)+z->get_spin(p5b)==z->get_spin(h3b)+z->get_spin(p4b)) { 
     if ((z->get_sym(h2b)^(z->get_sym(p5b)^(z->get_sym(h3b)^z->get_sym(p4b))))==(z->irrep_t()^z->irrep_e())) { 
  ...
  for (long h3b=0L;h3b<z->noab();++h3b) { 
   for (long q4b=z->noab()+z->nvab();q4b<z->nab();++q4b) { 
    if (z->get_spin(h2b)+z->get_spin(p5b)==z->get_spin(h3b)+z->get_spin(q4b)) { 
     if ((z->get_sym(h2b)^(z->get_sym(p5b)^(z->get_sym(h3b)^z->get_sym(q4b))))==(z->irrep_t()^z->irrep_e())) { 
...
void LAMBDA_CCSDPR12_T1::smith_0_7_0(){ 
  ...
  if (in[1]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h4b)+z->get_spin(h3b)!=4L) { 
    if (z->get_spin(h4b)==z->get_spin(h3b)) { 
     if ((z->get_sym(h4b)^z->get_sym(h3b))==z->irrep_e()) { 
      long dimc=z->get_range(h4b)*z->get_range(h3b); 
      long h4b_0,h3b_0; 
      z->restricted_2(h4b,h3b,h4b_0,h3b_0); 
      long dim_common=1L; 
      long dima0_sort=z->get_range(h4b)*z->get_range(h3b); 
      long dima0=dim_common*dima0_sort; 
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[1]->get_block(h3b_0+z->noab()*(h4b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h4b),z->get_range(h3b),0,1,+1.0,false); 
...
void LAMBDA_CCSDPR12_T1::smith_0_7_1(){ 
    ...
    if (z->get_spin(h4b)==z->get_spin(h3b)) { 
     if ((z->get_sym(h4b)^z->get_sym(h3b))==z->irrep_e()) { 
      ...
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[5]->get_block(h3b_0+z->noab()*(h4b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h4b),z->get_range(h3b),0,1,+1.0,false); 
...
for (long p3b=z->noab();p3b<z->noab()+z->nvab();++p3b) { 
 for (long p1b=z->noab();p1b<z->noab()+z->nvab();++p1b) { 
  ...
  if (in[1]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(p3b)+z->get_spin(p1b)!=4L) { 
    if (z->get_spin(p3b)==z->get_spin(p1b)) { 
     if ((z->get_sym(p3b)^z->get_sym(p1b))==(z->irrep_t()^z->irrep_e())) { 
      long dimc=z->get_range(p3b)*z->get_range(p1b); 
      double* k_c_sort=z->mem()->malloc_local_double(dimc); 
      std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
      for (long h4b=0L;h4b<z->noab();++h4b) { 
       if (z->get_spin(p3b)==z->get_spin(h4b)) { 
        if ((z->get_sym(p3b)^z->get_sym(h4b))==z->irrep_t()) { 
         ...
         if (dima0>0L && dima1>0L) { 
          ...
          double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
          double* k_a1=z->mem()->malloc_local_double(dima1); 
          kn[0]->get_block(p1b_1-z->noab()+z->nvab()*(h4b_1),k_a1); 
...
void LAMBDA_CCSDPR12_T1::smith_1_11_0(){ 
...
for (long h5b=0L;h5b<z->noab();++h5b) { 
 for (long h3b=0L;h3b<z->noab();++h3b) { 
  ...
  if (in[2]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h3b)!=4L) { 
    if (z->get_spin(h5b)==z->get_spin(h3b)) { 
     if ((z->get_sym(h5b)^z->get_sym(h3b))==z->irrep_e()) { 
      long dimc=z->get_range(h5b)*z->get_range(h3b); 
      long h5b_0,h3b_0; 
      z->restricted_2(h5b,h3b,h5b_0,h3b_0); 
      long dim_common=1L; 
      long dima0_sort=z->get_range(h5b)*z->get_range(h3b); 
      long dima0=dim_common*dima0_sort; 
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[1]->get_block(h3b_0+z->noab()*(h5b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h5b),z->get_range(h3b),0,1,-1.0,false); 
...
void LAMBDA_CCSDPR12_T1::smith_1_11_1(){ 
    ...
    if (z->get_spin(h5b)==z->get_spin(h3b)) { 
     if ((z->get_sym(h5b)^z->get_sym(h3b))==z->irrep_e()) { 
      ...
      if (dima0>0L) { 
       double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
       double* k_a0=z->mem()->malloc_local_double(dima0); 
       kn[5]->get_block(h3b_0+z->noab()*(h5b_0),k_a0); 
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h3b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(h5b),z->get_range(h3b),0,1,-1.0,false); 
          ...
          if ((z->get_sym(h4b)^(z->get_sym(h5b)^(z->get_sym(h3b)^z->get_sym(h6b))))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (h3b<h6b) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h5b),z->get_range(h3b),z->get_range(h6b),2,3,1,0,+1.0,false); 
            } 
            else if (h6b<=h3b) { 
             z->gt2()->get_block(h3b_0+z->noab()*(h6b_0+z->noab()*(h5b_0+z->noab()*(h4b_0))),k_a0); 
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(h5b),z->get_range(h6b),z->get_range(h3b),3,2,1,0,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h2b<h6b) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h4b),z->get_range(h5b),0,1,3,2,+1.0,false); 
            } 
            else if (h6b<=h2b) { 
             z->vr2()->get_block(h5b_1+z->noab()*(h4b_1+z->noab()*(h2b_1+(z->nab())*(h6b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(h2b),z->get_range(h4b),z->get_range(h5b),1,0,3,2,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            if (h4b==h5b) { 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(q5b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(q5b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(q5b)^(z->get_sym(h3b)^z->get_sym(h4b))))==(z->irrep_y()^z->irrep_e())) { 
         ...
         if (z->get_spin(h2b)==z->get_spin(p6b)) { 
          if ((z->get_sym(h2b)^z->get_sym(p6b))==z->irrep_y()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(q5b),z->get_range(h3b),z->get_range(h4b),3,2,1,0,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h4b),z->get_range(h3b),z->get_range(q5b),z->get_range(h2b),3,2,1,0,-1.0,false); 
        in[1]->add_block(h4b+z->noab()*(h3b+z->noab()*(q5b-z->noab()-z->nvab()+z->ncab()*(h2b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
   ...
   if (!z->restricted() || z->get_spin(q4b)+z->get_spin(h3b)!=4L) { 
    if (z->get_spin(q4b)==z->get_spin(h3b)) { 
     if ((z->get_sym(q4b)^z->get_sym(h3b))==(z->irrep_y()^z->irrep_e())) { 
        ...
        if (z->get_spin(h5b)==z->get_spin(p6b)) { 
         if ((z->get_sym(h5b)^z->get_sym(p6b))==z->irrep_y()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           z->sort_indices2(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(p6b),1,0,+1.0,false); 
           z->mem()->free_local_double(k_a0); 
           double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
           double* k_a1=z->mem()->malloc_local_double(dima1); 
           if (h3b<h5b) { 
            z->qy()->get_block(h5b_1+z->noab()*(h3b_1+z->noab()*(q4b_1-z->noab()-z->nvab()+z->ncab()*(p6b_1-z->noab()))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(q4b),z->get_range(h3b),z->get_range(h5b),2,1,0,3,+1.0,false); 
           } 
           else if (h5b<=h3b) { 
            z->qy()->get_block(h3b_1+z->noab()*(h5b_1+z->noab()*(q4b_1-z->noab()-z->nvab()+z->ncab()*(p6b_1-z->noab()))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(q4b),z->get_range(h5b),z->get_range(h3b),3,1,0,2,-1.0,false); 
           } 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(h3b),z->get_range(q4b),1,0,-1.0,false); 
         ...
         if (z->get_spin(p5b)==z->get_spin(h6b)) { 
          if ((z->get_sym(p5b)^z->get_sym(h6b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h2b<h6b) { 
             kn[2]->get_block(p4b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h6b_1+z->noab()*(h2b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h3b),z->get_range(p4b),3,2,0,1,+1.0,false); 
            } 
            else if (h6b<=h2b) { 
             kn[2]->get_block(p4b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h2b_1+z->noab()*(h6b_1))),k_a1); 
...
void LAMBDA_CCSDPR12_T1::smith_1_33_1(){ 
      ...
      if (z->get_spin(h2b)+z->get_spin(h7b)==z->get_spin(h4b)+z->get_spin(p6b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h7b)^(z->get_sym(h4b)^z->get_sym(p6b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[6]->get_block(p6b_0-z->noab()+z->nvab()*(h4b_0+z->noab()*(h7b_0+z->noab()*(h2b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h7b),z->get_range(h4b),z->get_range(p6b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h7b),z->get_range(h4b),z->get_range(p6b),0,1,2,3,-1.0,false); 
      ...
      if (z->get_spin(h2b)+z->get_spin(h7b)==z->get_spin(h4b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h7b)^(z->get_sym(h4b)^z->get_sym(q6b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h7b),z->get_range(h4b),z->get_range(q6b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h7b),z->get_range(h4b),z->get_range(q6b),0,1,2,3,+1.0,false); 
          ...
          if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
           if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(p5b),z->get_range(h6b),z->get_range(h7b),1,0,3,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h6b==h7b) { 
              factor=factor/2.0; 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(q5b)+z->get_spin(h3b)+z->get_spin(p4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(q5b)==z->get_spin(h3b)+z->get_spin(p4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(q5b)^(z->get_sym(h3b)^z->get_sym(p4b))))==(z->irrep_y()^z->irrep_e())) { 
           ...
           if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(p4b)^z->get_sym(p7b))))==z->irrep_y()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h2b<h6b && p4b<p7b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(p4b),z->get_range(p7b),2,0,3,1,+1.0,false); 
             } 
             else if (h2b<h6b && p7b<=p4b) { 
              z->lambda2()->get_block(p4b_0-z->noab()+z->nvab()*(p7b_0-z->noab()+z->nvab()*(h6b_0+z->noab()*(h2b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(p7b),z->get_range(p4b),3,0,2,1,-1.0,false); 
             } 
             else if (h6b<=h2b && p4b<p7b) { 
              z->lambda2()->get_block(p7b_0-z->noab()+z->nvab()*(p4b_0-z->noab()+z->nvab()*(h2b_0+z->noab()*(h6b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h2b),z->get_range(p4b),z->get_range(p7b),2,1,3,0,-1.0,false); 
             } 
             else if (h6b<=h2b && p7b<=p4b) { 
              z->lambda2()->get_block(p4b_0-z->noab()+z->nvab()*(p7b_0-z->noab()+z->nvab()*(h2b_0+z->noab()*(h6b_0))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h2b),z->get_range(p7b),z->get_range(p4b),3,1,2,0,+1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h3b<h6b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(p7b),z->get_range(q5b),z->get_range(h3b),z->get_range(h6b),2,1,0,3,+1.0,false); 
             } 
             else if (h6b<=h3b) { 
              z->qy()->get_block(h3b_1+z->noab()*(h6b_1+z->noab()*(q5b_1-z->noab()-z->nvab()+z->ncab()*(p7b_1-z->noab()))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(p7b),z->get_range(q5b),z->get_range(h6b),z->get_range(h3b),3,1,0,2,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h3b),z->get_range(q5b),z->get_range(p4b),z->get_range(h2b),3,1,0,2,+1.0,false); 
   ...
   if (!z->restricted() || z->get_spin(q4b)+z->get_spin(p3b)!=4L) { 
    if (z->get_spin(q4b)==z->get_spin(p3b)) { 
     if ((z->get_sym(q4b)^z->get_sym(p3b))==(z->irrep_y()^z->irrep_e())) { 
          ...
          if ((z->get_sym(h5b)^(z->get_sym(h6b)^(z->get_sym(p3b)^z->get_sym(p7b))))==z->irrep_y()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (p3b<p7b) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p3b),z->get_range(p7b),2,3,1,0,+1.0,false); 
            } 
            else if (p7b<=p3b) { 
             z->lambda2()->get_block(p3b_0-z->noab()+z->nvab()*(p7b_0-z->noab()+z->nvab()*(h6b_0+z->noab()*(h5b_0))),k_a0); 
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p7b),z->get_range(p3b),3,2,1,0,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            z->qy()->get_block(h6b_1+z->noab()*(h5b_1+z->noab()*(q4b_1-z->noab()-z->nvab()+z->ncab()*(p7b_1-z->noab()))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p7b),z->get_range(q4b),z->get_range(h5b),z->get_range(h6b),1,0,3,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            if (h5b==h6b) { 
             factor=factor/2.0; 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q4b),z->get_range(p3b),0,1,-0.5/0.5,false); 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(p5b)+z->get_spin(h3b)+z->get_spin(q4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(p5b)==z->get_spin(h3b)+z->get_spin(q4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(p5b)^(z->get_sym(h3b)^z->get_sym(q4b))))==(z->irrep_t()^z->irrep_e())) { 
         ...
         if (z->get_spin(p5b)==z->get_spin(h6b)) { 
          if ((z->get_sym(p5b)^z->get_sym(h6b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            if (h2b<h6b) { 
             kn[3]->get_block(q4b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(h6b_1+z->noab()*(h2b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h3b),z->get_range(q4b),3,2,0,1,+1.0,false); 
            } 
            else if (h6b<=h2b) { 
             kn[3]->get_block(q4b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(h2b_1+z->noab()*(h6b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h6b),z->get_range(h2b),z->get_range(h3b),z->get_range(q4b),3,2,1,0,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q4b),z->get_range(h3b),z->get_range(h2b),z->get_range(p5b),2,3,1,0,-1.0,false); 
...
void LAMBDA_CCSDPR12_T1::smith_1_49_0(){ 
  ...
  for (long h3b=0L;h3b<z->noab();++h3b) { 
   for (long h4b=h3b;h4b<z->noab();++h4b) { 
    ...
    if (in[2]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_e()) { 
        long dimc=z->get_range(h2b)*z->get_range(h6b)*z->get_range(h3b)*z->get_range(h4b); 
        long h2b_0,h6b_0,h3b_0,h4b_0; 
        z->restricted_4(h2b,h6b,h3b,h4b,h2b_0,h6b_0,h3b_0,h4b_0); 
        long dim_common=1L; 
        long dima0_sort=z->get_range(h2b)*z->get_range(h6b)*z->get_range(h3b)*z->get_range(h4b); 
        long dima0=dim_common*dima0_sort; 
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[7]->get_block(h4b_0+z->noab()*(h3b_0+z->noab()*(h6b_0+z->noab()*(h2b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h6b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,+1.0,false); 
...
void LAMBDA_CCSDPR12_T1::smith_1_49_1(){ 
      ...
      if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_e()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[4]->get_block(h4b_0+z->noab()*(h3b_0+z->noab()*(h6b_0+z->noab()*(h2b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h6b),z->get_range(h3b),z->get_range(h4b),0,1,2,3,+1.0,false); 
         ...
         if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
          if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[0]->get_block(p6b_1-z->noab()+z->nvab()*(h2b_1),k_a1); 
            z->sort_indices2(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(p6b),0,1,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
          ...
          if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(h7b)) { 
           if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(h7b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h2b<h7b) { 
              kn[2]->get_block(p6b_1-z->noab()+z->nvab()*(h4b_1+z->noab()*(h7b_1+z->noab()*(h2b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h7b),z->get_range(h4b),z->get_range(p6b),2,0,3,1,+1.0,false); 
             } 
             else if (h7b<=h2b) { 
              kn[2]->get_block(p6b_1-z->noab()+z->nvab()*(h4b_1+z->noab()*(h2b_1+z->noab()*(h7b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(h2b),z->get_range(h4b),z->get_range(p6b),2,1,3,0,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
        ...
        if (z->get_spin(p5b)==z->get_spin(h3b)) { 
         if ((z->get_sym(p5b)^z->get_sym(h3b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
           double* k_a1=z->mem()->malloc_local_double(dima1); 
           kn[5]->get_block(h4b_1+z->noab()*(h2b_1),k_a1); 
         ...
         if (z->get_spin(p4b)+z->get_spin(p5b)==z->get_spin(h6b)+z->get_spin(h7b)) { 
          if ((z->get_sym(p4b)^(z->get_sym(p5b)^(z->get_sym(h6b)^z->get_sym(h7b))))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[2]->get_block(p5b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h7b_1+z->noab()*(h6b_1))),k_a1); 
         ...
         if (z->get_spin(p5b)+z->get_spin(q6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
          if ((z->get_sym(p5b)^(z->get_sym(q6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q6b),z->get_range(h3b),z->get_range(h4b),3,2,0,1,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
  ...
  for (long h3b=0L;h3b<z->noab();++h3b) { 
   for (long h4b=0L;h4b<z->noab();++h4b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(q5b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(q5b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(q5b)^(z->get_sym(h3b)^z->get_sym(h4b))))==(z->irrep_e()^z->irrep_e())) { 
        long dimc=z->get_range(h2b)*z->get_range(q5b)*z->get_range(h3b)*z->get_range(h4b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h7b=0L;h7b<z->noab();++h7b) { 
...
for (long q4b=z->noab()+z->nvab();q4b<z->nab();++q4b) { 
 for (long h3b=0L;h3b<z->noab();++h3b) { 
  ...
  if (in[1]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(q4b)+z->get_spin(h3b)!=4L) { 
    if (z->get_spin(q4b)==z->get_spin(h3b)) { 
     if ((z->get_sym(q4b)^z->get_sym(h3b))==(z->irrep_e()^z->irrep_e())) { 
      long dimc=z->get_range(q4b)*z->get_range(h3b); 
      double* k_c_sort=z->mem()->malloc_local_double(dimc); 
      std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
      for (long h6b=0L;h6b<z->noab();++h6b) { 
         ...
         if (z->get_spin(p5b)+z->get_spin(q4b)==z->get_spin(h6b)+z->get_spin(h7b)) { 
          if ((z->get_sym(p5b)^(z->get_sym(q4b)^(z->get_sym(h6b)^z->get_sym(h7b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q4b),z->get_range(h6b),z->get_range(h7b),1,0,3,2,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[2]->get_block(p5b_1-z->noab()+z->nvab()*(h3b_1+z->noab()*(h7b_1+z->noab()*(h6b_1))),k_a1); 
       ...
       if (z->get_spin(p4b)==z->get_spin(h3b)) { 
        if ((z->get_sym(p4b)^z->get_sym(h3b))==z->irrep_t()) { 
         ...
         if (dima0>0L && dima1>0L) { 
          ...
          double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
          double* k_a1=z->mem()->malloc_local_double(dima1); 
          kn[0]->get_block(p4b_1-z->noab()+z->nvab()*(h2b_1),k_a1); 
...
void LAMBDA_CCSDPR12_T1::smith_2_29_1(){ 
      ...
      if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h4b)+z->get_spin(p7b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h4b)^z->get_sym(p7b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         double* k_a0_sort=z->mem()->malloc_local_double(dima0); 
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         kn[6]->get_block(p7b_0-z->noab()+z->nvab()*(h4b_0+z->noab()*(h6b_0+z->noab()*(h2b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h4b),z->get_range(p7b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h2b),z->get_range(h6b),z->get_range(h4b),z->get_range(p7b),0,1,2,3,+1.0,false); 
          ...
          if (z->get_spin(h7b)+z->get_spin(h8b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
           if ((z->get_sym(h7b)^(z->get_sym(h8b)^(z->get_sym(h3b)^z->get_sym(h4b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h8b),z->get_range(h3b),z->get_range(h4b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->vr2()->get_block(h8b_1+z->noab()*(h7b_1+z->noab()*(h6b_1+(z->nab())*(h2b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h7b),z->get_range(h8b),1,0,3,2,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h7b==h8b) { 
              factor=factor/2.0; 
   ...
   if (!z->restricted() || z->get_spin(h2b)+z->get_spin(q6b)!=4L) { 
    if (z->get_spin(h2b)==z->get_spin(q6b)) { 
     if ((z->get_sym(h2b)^z->get_sym(q6b))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if ((z->get_sym(p7b)^z->get_sym(h8b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           if (h2b<h8b) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h8b),z->get_range(p7b),z->get_range(q6b),3,0,2,1,+1.0,false); 
           } 
           else if (h8b<=h2b) { 
            z->v2()->get_block(q6b_1+(z->nab())*(p7b_1+(z->nab())*(h2b_1+(z->nab())*(h8b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h2b),z->get_range(p7b),z->get_range(q6b),3,1,2,0,-1.0,false); 
           } 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q6b),z->get_range(h2b),1,0,-1.0,false); 
...
void LAMBDA_CCSDPR12_T1::smith_k0(){ 
   ...
   if (!z->restricted() || z->get_spin(h2b)+z->get_spin(p6b)!=4L) { 
    if (z->get_spin(h2b)==z->get_spin(p6b)) { 
     if ((z->get_sym(h2b)^z->get_sym(p6b))==(z->irrep_t()^z->irrep_v())) { 
      ...
      kn[0]->add_block(p6b-z->noab()+z->nvab()*(h2b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
    } 
...
void LAMBDA_CCSDPR12_T1::smith_k1(){ 
   ...
   if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h3b)!=4L) { 
    if (z->get_spin(h5b)==z->get_spin(h3b)) { 
     if ((z->get_sym(h5b)^z->get_sym(h3b))==(z->irrep_t()^z->irrep_y())) { 
      ...
      kn[1]->add_block(h3b+z->noab()*(h5b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
    } 
...
void LAMBDA_CCSDPR12_T1::smith_k2(){ 
     ...
     if (!z->restricted() || z->get_spin(h6b)+z->get_spin(h7b)+z->get_spin(h3b)+z->get_spin(p5b)!=8L) { 
      if (z->get_spin(h6b)+z->get_spin(h7b)==z->get_spin(h3b)+z->get_spin(p5b)) { 
       if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(h3b)^z->get_sym(p5b))))==(z->irrep_t()^z->irrep_y())) { 
        ...
        kn[2]->add_block(p5b-z->noab()+z->nvab()*(h3b+z->noab()*(h7b+z->noab()*(h6b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void LAMBDA_CCSDPR12_T1::smith_k3(){ 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(q4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(q4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(q4b))))==(z->irrep_t()^z->irrep_y())) { 
         ...
         if (z->get_spin(p7b)==z->get_spin(h3b)) { 
          if ((z->get_sym(p7b)^z->get_sym(h3b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(p7b),z->get_range(q4b),3,1,0,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q4b),z->get_range(h6b),z->get_range(h2b),z->get_range(h3b),2,1,3,0,+1.0,false); 
        kn[3]->add_block(q4b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(h6b+z->noab()*(h2b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void LAMBDA_CCSDPR12_T1::smith_k4(){ 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==(z->irrep_t()^z->irrep_y())) { 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h6b),z->get_range(h2b),z->get_range(h4b),z->get_range(h3b),1,0,3,2,+0.5/0.5,false); 
        kn[4]->add_block(h4b+z->noab()*(h3b+z->noab()*(h6b+z->noab()*(h2b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void LAMBDA_CCSDPR12_T1::smith_k5(){ 
   ...
   if (!z->restricted() || z->get_spin(h5b)+z->get_spin(h3b)!=4L) { 
    if (z->get_spin(h5b)==z->get_spin(h3b)) { 
     if ((z->get_sym(h5b)^z->get_sym(h3b))==(z->irrep_t()^z->irrep_y())) { 
      ...
      kn[5]->add_block(h3b+z->noab()*(h5b),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
    } 
...
void LAMBDA_CCSDPR12_T1::smith_k6(){ 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h7b)+z->get_spin(h4b)+z->get_spin(p6b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(h7b)==z->get_spin(h4b)+z->get_spin(p6b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h7b)^(z->get_sym(h4b)^z->get_sym(p6b))))==(z->irrep_t()^z->irrep_v())) { 
        ...
        kn[6]->add_block(p6b-z->noab()+z->nvab()*(h4b+z->noab()*(h7b+z->noab()*(h2b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      } 
...
void LAMBDA_CCSDPR12_T1::smith_k7(){ 
     ...
     if (!z->restricted() || z->get_spin(h2b)+z->get_spin(h6b)+z->get_spin(h3b)+z->get_spin(h4b)!=8L) { 
      if (z->get_spin(h2b)+z->get_spin(h6b)==z->get_spin(h3b)+z->get_spin(h4b)) { 
       if ((z->get_sym(h2b)^(z->get_sym(h6b)^(z->get_sym(h3b)^z->get_sym(h4b))))==(z->irrep_t()^z->irrep_e())) { 
         ...
         if (z->get_spin(p7b)==z->get_spin(h3b)) { 
          if ((z->get_sym(p7b)^z->get_sym(h3b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            kn[2]->get_block(p7b_1-z->noab()+z->nvab()*(h4b_1+z->noab()*(h6b_1+z->noab()*(h2b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h2b),z->get_range(h6b),z->get_range(h4b),z->get_range(p7b),2,1,0,3,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        if (h4b>=h3b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h4b),z->get_range(h6b),z->get_range(h2b),z->get_range(h3b),2,1,3,0,+1.0,false); 
         kn[7]->add_block(h4b+z->noab()*(h3b+z->noab()*(h6b+z->noab()*(h2b))),k_c); 
        } 
        if (h3b>=h4b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h4b),z->get_range(h6b),z->get_range(h2b),z->get_range(h3b),2,1,0,3,-1.0,false); 
         kn[7]->add_block(h3b+z->noab()*(h4b+z->noab()*(h6b+z->noab()*(h2b))),k_c); 
        } 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
