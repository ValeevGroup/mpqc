...
kn.at(0)=new Tensor("lambda_ccsdpr12_t2_k0",z->mem());
offset_k0();
smith_k0(); //z->t1(),z->v2()=>kn.at(0)
kn.at(1)=new Tensor("lambda_ccsdpr12_t2_k1",z->mem());
offset_k1();
smith_k1(); //z->t1(),z->v2()=>kn.at(1)
kn.at(2)=new Tensor("lambda_ccsdpr12_t2_k2",z->mem());
offset_k2();
...
smith_1_24(); //z->t1(),kn.at(0)=>in.at(1)
...
smith_1_26(); //z->t1(),kn.at(0)=>in.at(1)
...
smith_1_27(); //z->t1(),kn.at(1)=>in.at(1)
...
offset_smith_0_28();
smith_1_28(); //z->t1(),kn.at(2)=>in.at(1)
...
void LAMBDA_CCSDPR12_T2::offset_k0(){ 
...
void LAMBDA_CCSDPR12_T2::offset_k1(){ 
...
void LAMBDA_CCSDPR12_T2::offset_k2(){ 
      ...
      if (z->get_spin(h4b)+z->get_spin(q6b)==z->get_spin(h5b)+z->get_spin(p2b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(q6b)^(z->get_sym(h5b)^z->get_sym(p2b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h4b),z->get_range(q6b),z->get_range(h5b),z->get_range(p2b),0,1,2,3,+1.0,false); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h4b),z->get_range(q6b),z->get_range(h5b),z->get_range(p2b),0,1,2,3,-1.0,false); 
          ...
          if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h5b)+z->get_spin(h6b)) { 
           if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h5b)^z->get_sym(h6b))))==z->irrep_y()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h5b),z->get_range(h6b),z->get_range(p1b),z->get_range(p2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h5b==h6b) { 
              factor=factor/2.0; 
  ...
  for (long p1b=z->noab();p1b<z->noab()+z->nvab();++p1b) { 
   for (long p2b=z->noab();p2b<z->noab()+z->nvab();++p2b) { 
    ...
    if (out->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(p1b)+z->get_spin(p2b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(p1b)+z->get_spin(p2b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(p1b)^z->get_sym(p2b))))==(z->irrep_v()^z->irrep_e())) { 
        long dimc=z->get_range(h3b)*z->get_range(h4b)*z->get_range(p1b)*z->get_range(p2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h5b=0L;h5b<z->noab();++h5b) { 
          ...
          if (z->get_spin(h5b)+z->get_spin(q6b)==z->get_spin(p1b)+z->get_spin(p2b)) { 
           if ((z->get_sym(h5b)^(z->get_sym(q6b)^(z->get_sym(p1b)^z->get_sym(p2b))))==z->irrep_v()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h5b),z->get_range(q6b),z->get_range(p1b),z->get_range(p2b),3,2,1,0,+1.0,false); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
  ...
  for (long p1b=z->noab();p1b<z->noab()+z->nvab();++p1b) { 
   for (long p2b=p1b;p2b<z->noab()+z->nvab();++p2b) { 
    ...
    if (out->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(p1b)+z->get_spin(p2b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(p1b)+z->get_spin(p2b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(p1b)^z->get_sym(p2b))))==(z->irrep_v()^(z->irrep_t()^z->irrep_e()))) { 
        long dimc=z->get_range(h3b)*z->get_range(h4b)*z->get_range(p1b)*z->get_range(p2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h5b=0L;h5b<z->noab();++h5b) { 
...
void LAMBDA_CCSDPR12_T2::smith_0_2_1(){ 
        ...
        if (z->get_spin(h3b)==z->get_spin(p1b)) { 
         if ((z->get_sym(h3b)^z->get_sym(p1b))==z->irrep_y()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
           double* k_a1=z->mem()->malloc_local_double(dima1); 
           kn[0]->get_block(p2b_1-z->noab()+z->nvab()*(h4b_1),k_a1); 
    ...
    if (z->get_spin(q5b)==z->get_spin(p2b)) { 
     if ((z->get_sym(q5b)^z->get_sym(p2b))==z->irrep_f()) { 
      ...
      if (dima0>0L) { 
       ...
       z->sort_indices2(k_a0,k_a0_sort,z->get_range(q5b),z->get_range(p2b),0,1,+1.0,false); 
       z->mem()->free_local_double(k_a0); 
       double* k_c=z->mem()->malloc_local_double(dimc); 
       z->sort_indices2(k_a0_sort,k_c,z->get_range(q5b),z->get_range(p2b),0,1,+1.0,false); 
...
void LAMBDA_CCSDPR12_T2::smith_1_16_1(){ 
   ...
   if (!z->restricted() || z->get_spin(q5b)+z->get_spin(p2b)!=4L) { 
    if (z->get_spin(q5b)==z->get_spin(p2b)) { 
     if ((z->get_sym(q5b)^z->get_sym(p2b))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if ((z->get_sym(p6b)^z->get_sym(h7b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           if (p2b<p6b) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(q5b),z->get_range(p2b),z->get_range(p6b),2,1,3,0,+1.0,false); 
           } 
           else if (p6b<=p2b) { 
            z->v2()->get_block(p2b_1+(z->nab())*(p6b_1+(z->nab())*(q5b_1+(z->nab())*(h7b_1))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(q5b),z->get_range(p6b),z->get_range(p2b),3,1,2,0,-1.0,false); 
           } 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(p2b),z->get_range(q5b),1,0,-1.0,false); 
      in[1]->add_block(p2b-z->noab()+z->nvab()*(q5b-z->noab()-z->nvab()),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
     ...
     if (!z->restricted() || z->get_spin(h4b)+z->get_spin(q6b)+z->get_spin(h5b)+z->get_spin(p2b)!=8L) { 
      if (z->get_spin(h4b)+z->get_spin(q6b)==z->get_spin(h5b)+z->get_spin(p2b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(q6b)^(z->get_sym(h5b)^z->get_sym(p2b))))==(z->irrep_t()^z->irrep_v())) { 
          ...
          if ((z->get_sym(p7b)^z->get_sym(h5b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (p2b<p7b) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(q6b),z->get_range(p2b),z->get_range(p7b),2,1,0,3,+1.0,false); 
            } 
            else if (p7b<=p2b) { 
             z->v2()->get_block(p2b_1+(z->nab())*(p7b_1+(z->nab())*(q6b_1+(z->nab())*(h4b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(q6b),z->get_range(p7b),z->get_range(p2b),3,1,0,2,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p2b),z->get_range(q6b),z->get_range(h4b),z->get_range(h5b),2,1,3,0,+1.0,false); 
        in[1]->add_block(p2b-z->noab()+z->nvab()*(h5b+z->noab()*(q6b-z->noab()-z->nvab()+z->ncab()*(h4b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(h3b)+z->get_spin(h4b)+z->get_spin(h5b)+z->get_spin(q6b)!=8L) { 
      if (z->get_spin(h3b)+z->get_spin(h4b)==z->get_spin(h5b)+z->get_spin(q6b)) { 
       if ((z->get_sym(h3b)^(z->get_sym(h4b)^(z->get_sym(h5b)^z->get_sym(q6b))))==(z->irrep_t()^z->irrep_y())) { 
         ...
         if (z->get_spin(p7b)==z->get_spin(h5b)) { 
          if ((z->get_sym(p7b)^z->get_sym(h5b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h3b),z->get_range(h4b),z->get_range(p7b),z->get_range(q6b),3,1,0,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q6b),z->get_range(h4b),z->get_range(h3b),z->get_range(h5b),2,1,3,0,-1.0,false); 
       ...
       if (z->get_spin(p6b)==z->get_spin(h5b)) { 
        if ((z->get_sym(p6b)^z->get_sym(h5b))==z->irrep_t()) { 
         ...
         if (dima0>0L && dima1>0L) { 
          ...
          double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
          double* k_a1=z->mem()->malloc_local_double(dima1); 
          kn[0]->get_block(p6b_1-z->noab()+z->nvab()*(h4b_1),k_a1); 
...
for (long p5b=z->noab();p5b<z->noab()+z->nvab();++p5b) { 
 for (long p2b=z->noab();p2b<z->noab()+z->nvab();++p2b) { 
  ...
  if (in[1]->is_this_local(tileoffset)) { 
   if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p2b)!=4L) { 
    if (z->get_spin(p5b)==z->get_spin(p2b)) { 
     if ((z->get_sym(p5b)^z->get_sym(p2b))==(z->irrep_t()^z->irrep_e())) { 
      long dimc=z->get_range(p5b)*z->get_range(p2b); 
      double* k_c_sort=z->mem()->malloc_local_double(dimc); 
      std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
      for (long h6b=0L;h6b<z->noab();++h6b) { 
  ...
  for (long h5b=0L;h5b<z->noab();++h5b) { 
   for (long p2b=z->noab();p2b<z->noab()+z->nvab();++p2b) { 
    ...
    if (in[1]->is_this_local(tileoffset)) { 
     if (!z->restricted() || z->get_spin(h4b)+z->get_spin(p6b)+z->get_spin(h5b)+z->get_spin(p2b)!=8L) { 
      if (z->get_spin(h4b)+z->get_spin(p6b)==z->get_spin(h5b)+z->get_spin(p2b)) { 
       if ((z->get_sym(h4b)^(z->get_sym(p6b)^(z->get_sym(h5b)^z->get_sym(p2b))))==(z->irrep_t()^z->irrep_e())) { 
        long dimc=z->get_range(h4b)*z->get_range(p6b)*z->get_range(h5b)*z->get_range(p2b); 
        double* k_c_sort=z->mem()->malloc_local_double(dimc); 
        std::fill(k_c_sort,k_c_sort+(size_t)dimc,0.0); 
        for (long h7b=0L;h7b<z->noab();++h7b) { 
         ...
         if (z->get_spin(p5b)+z->get_spin(q6b)==z->get_spin(h7b)+z->get_spin(h8b)) { 
          if ((z->get_sym(p5b)^(z->get_sym(q6b)^(z->get_sym(h7b)^z->get_sym(h8b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q6b),z->get_range(h7b),z->get_range(h8b),0,1,3,2,+1.0,false); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
           ...
           if ((z->get_sym(p6b)^(z->get_sym(q7b)^(z->get_sym(h5b)^z->get_sym(h8b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h5b<h8b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q7b),z->get_range(h5b),z->get_range(h8b),2,0,1,3,+1.0,false); 
             } 
             else if (h8b<=h5b) { 
              z->qy()->get_block(h5b_0+z->noab()*(h8b_0+z->noab()*(q7b_0-z->noab()-z->nvab()+z->ncab()*(p6b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q7b),z->get_range(h8b),z->get_range(h5b),3,0,1,2,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h4b<h8b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h4b),z->get_range(h8b),z->get_range(p2b),z->get_range(q7b),2,0,3,1,+1.0,false); 
             } 
             else if (h8b<=h4b) { 
              z->v2()->get_block(q7b_1+(z->nab())*(p2b_1+(z->nab())*(h4b_1+(z->nab())*(h8b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h4b),z->get_range(p2b),z->get_range(q7b),2,1,3,0,-1.0,false); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
   ...
   if (!z->restricted() || z->get_spin(q5b)+z->get_spin(p2b)!=4L) { 
    if (z->get_spin(q5b)==z->get_spin(p2b)) { 
     if ((z->get_sym(q5b)^z->get_sym(p2b))==(z->irrep_y()^z->irrep_e())) { 
          ...
          if ((z->get_sym(h6b)^(z->get_sym(h7b)^(z->get_sym(p2b)^z->get_sym(p8b))))==z->irrep_y()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (p2b<p8b) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h7b),z->get_range(p2b),z->get_range(p8b),2,3,1,0,+1.0,false); 
            } 
            else if (p8b<=p2b) { 
             z->lambda2()->get_block(p2b_0-z->noab()+z->nvab()*(p8b_0-z->noab()+z->nvab()*(h7b_0+z->noab()*(h6b_0))),k_a0); 
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h6b),z->get_range(h7b),z->get_range(p8b),z->get_range(p2b),3,2,1,0,-1.0,false); 
            } 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
            z->qy()->get_block(h7b_1+z->noab()*(h6b_1+z->noab()*(q5b_1-z->noab()-z->nvab()+z->ncab()*(p8b_1-z->noab()))),k_a1); 
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p8b),z->get_range(q5b),z->get_range(h6b),z->get_range(h7b),1,0,3,2,+1.0,false); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            if (h6b==h7b) { 
             factor=factor/2.0; 
      ...
      double* k_c=z->mem()->malloc_local_double(dimc); 
      z->sort_indices2(k_c_sort,k_c,z->get_range(q5b),z->get_range(p2b),0,1,+0.5/0.5,false); 
      in[1]->add_block(p2b-z->noab()+z->nvab()*(q5b-z->noab()-z->nvab()),k_c); 
      z->mem()->free_local_double(k_c); 
      z->mem()->free_local_double(k_c_sort); 
     } 
...
void LAMBDA_CCSDPR12_T2::smith_k0(){ 
...
void LAMBDA_CCSDPR12_T2::smith_k1(){ 
...
void LAMBDA_CCSDPR12_T2::smith_k2(){ 
