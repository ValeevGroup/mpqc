...
/*--------------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------------*/
inline void G12Libint2::g12_quartet_data_(g12libint2::prim_data *Data, double scale, double gamma, bool eri_only)
{
...
#include "static.h"
  ...
  if (eri_only) {
      ...
      if(T < small_T){
          g12libint2::assign_FjT(Data,quartet_info_.am,oo2np1,pfac);
        }
      else {
          double *fjttable = Fm_Eval_->values(quartet_info_.am,T);
          g12libint2::assign_FjT(Data,quartet_info_.am,fjttable,pfac);
        }
      return;
    }
  ...
  g12libint2::assign_FjT(Data,quartet_info_.am,ss_m1_ss,pfac);
