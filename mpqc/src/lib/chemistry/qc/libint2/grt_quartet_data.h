...
#ifndef _chemistry_qc_libint2_grtquartetdata_h
#define _chemistry_qc_libint2_grtquartetdata_h
...
/*--------------------------------------------------------------------------------
 ...
 --------------------------------------------------------------------------------*/
inline void GRTLibint2::grt_quartet_data_(prim_data *Data, double scale)
{
