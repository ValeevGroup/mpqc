...
void Int2eLibint2::sort_contrquartets_to_shellquartet_(double *source_ints_buf, double *target_ints_buf)
{
...
//void Int2eLibint2::get_nonredundant_ints_(double *source, double *target, int e13e24, int e12, int e34)
//{
//  if (e13e24 && e12 && e34)
...
void Int2eLibint2::permute_target_(double *s, double *t, int p13p24, int p12, int p34)
{
  if (!p13p24) {
    if (p12)
      if (p34)
...
void Int2eLibint2::permute_1234_to_1243_(double *source_ints_buf, double *target_ints_buf)
{
  int nbf1 = int_shell1_->nfunction();
  int nbf2 = int_shell2_->nfunction();
...
void Int2eLibint2::permute_1234_to_2134_(double *source_ints_buf, double *target_ints_buf)
{
...
void Int2eLibint2::permute_1234_to_2143_(double *source_ints_buf, double *target_ints_buf)
{
  int nbf1 = int_shell2_->nfunction();
  int nbf2 = int_shell1_->nfunction();
  int nbf3 = int_shell4_->nfunction();
...
void Int2eLibint2::permute_1234_to_3412_(double *source_ints_buf, double *target_ints_buf)
{
...
void Int2eLibint2::permute_1234_to_4312_(double *source_ints_buf, double *target_ints_buf)
{
...
void Int2eLibint2::permute_1234_to_3421_(double *source_ints_buf, double *target_ints_buf)
{
  int nbf1 = int_shell3_->nfunction();
  int nbf2 = int_shell4_->nfunction();
...
void Int2eLibint2::permute_1234_to_4321_(double *source_ints_buf, double *target_ints_buf)
{
  int nbf1 = int_shell4_->nfunction();
  int nbf2 = int_shell3_->nfunction();
  int nbf3 = int_shell2_->nfunction();
