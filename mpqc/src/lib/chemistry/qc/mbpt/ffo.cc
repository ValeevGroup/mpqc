...
static void
make_fock(dmt_matrix S, centers_t *_centers,
          scf_struct_t *_scf_info, sym_struct_t *_sym_info,
          dmt_matrix FOCK, dmt_matrix FOCKO,
          dmt_matrix GMAT, dmt_matrix GMATO,
          dmt_matrix SSCR1, dmt_matrix SSCR2,
          FILE *_outfile);
