...
R12IntEval::abs1_contrib_to_VXB_gebc_()
{
  ...
  ikjy_tform_->set_num_te_types(num_te_types);
  ikjy_tform_->compute();
  Ref<R12IntsAcc> ikjy_acc = ikjy_tform_->ints_acc();
  if (num_te_types != ikjy_acc->num_te_types())
  ...
  int nproc_with_ints = tasks_with_ints_(ikjy_acc,proc_with_ints);
  ...
  if (ikjy_acc->has_access(me)) {
    ...
    for(kl_iter.start();int(kl_iter);kl_iter.next()) {
      ...
      double *klox_buf_eri = ikjy_acc->retrieve_pair_block(k,l,R12IntsAcc::eri);
      double *klox_buf_r12 = ikjy_acc->retrieve_pair_block(k,l,R12IntsAcc::r12);
      double *klox_buf_r12t1 = ikjy_acc->retrieve_pair_block(k,l,R12IntsAcc::r12t1);
      double *klox_buf_r12t2 = ikjy_acc->retrieve_pair_block(k,l,R12IntsAcc::r12t2);

      double *lkox_buf_eri = ikjy_acc->retrieve_pair_block(l,k,R12IntsAcc::eri);
      double *lkox_buf_r12 = ikjy_acc->retrieve_pair_block(l,k,R12IntsAcc::r12);
      double *lkox_buf_r12t1 = ikjy_acc->retrieve_pair_block(l,k,R12IntsAcc::r12t1);
      double *lkox_buf_r12t2 = ikjy_acc->retrieve_pair_block(l,k,R12IntsAcc::r12t2);
      ...
      for(ij_iter.start(kl+1);int(ij_iter);ij_iter.next()) {
        ...
        tim_enter("MO ints retrieve");
        double *ijox_buf_r12 = ikjy_acc->retrieve_pair_block(i,j,R12IntsAcc::r12);
        double *jiox_buf_r12 = ikjy_acc->retrieve_pair_block(j,i,R12IntsAcc::r12);
        tim_exit("MO ints retrieve");
...
#endif
        ikjy_acc->release_pair_block(i,j,R12IntsAcc::r12);
        ikjy_acc->release_pair_block(j,i,R12IntsAcc::r12);
      }
      ikjy_acc->release_pair_block(k,l,R12IntsAcc::eri);
      ikjy_acc->release_pair_block(k,l,R12IntsAcc::r12);
      ikjy_acc->release_pair_block(k,l,R12IntsAcc::r12t1);
      ikjy_acc->release_pair_block(k,l,R12IntsAcc::r12t2);
      ikjy_acc->release_pair_block(l,k,R12IntsAcc::eri);
      ikjy_acc->release_pair_block(l,k,R12IntsAcc::r12);
      ikjy_acc->release_pair_block(l,k,R12IntsAcc::r12t1);
      ikjy_acc->release_pair_block(l,k,R12IntsAcc::r12t2);
    }
  }
