    ...
    */
    ...
    class GeminalDescriptor : public RefCount {
      private:
        std::string type_;
        /**
         * vector of dimension nfunctions+1 containing the start indices
         * for the parameterset of each function. This vector in generated by
         * the function compute_offsets.
         */
