...
#ifndef _mpqc_src_lib_chemistry_qc_mbptr12_registries_h
#define _mpqc_src_lib_chemistry_qc_mbptr12_registries_h

#include <chemistry/qc/mbptr12/registry.h>

namespace sc {

  /// registry of globally-known one-particle densities
  typedef Registry<std::string, RefSymmSCMatrix,
    detail::SingletonCreationPolicy> OneParticleDensityRegistry;
