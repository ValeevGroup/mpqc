...
#ifndef _chemistry_qc_mbptr12_vxbevalb_h
#define _chemistry_qc_mbptr12_vxbevalb_h
...
namespace sc {
  ...
  /** Class R12IntEval_B evaluates R12 intermediates for the two-basis MP2-R12 theory
      in standard approximation B (with assumption of EBC and GBC) */

class R12IntEval_B : virtual public SavableState {
...
public:
  R12IntEval_B(StateIn&);
  R12IntEval_B(Ref<R12IntEvalInfo>&);
  ~R12IntEval_B();
