...
{  
  ...
  if (!psi_in.test()){
    psi_in.write_input_file(do_gradient() ? "FIRST" : "NONE", "CCSD",
...
PSI_CCSD::value_implemented()
{
  return 1;
}

PSI_CCSD::gradient_implemented()
{
  return 1;
}
