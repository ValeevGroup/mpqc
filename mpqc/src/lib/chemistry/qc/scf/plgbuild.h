...
#ifndef _chemistry_qc_scf_plgbuild_h
#define _chemistry_qc_scf_plgbuild_h
...
template<class T>
class ParallelLocalGBuild : public GBuild<T> {
  protected:
    RefMessageGrp grp_;
    RefTwoBodyInt tbi_;
  ...
  public:
    ParallelLocalGBuild(T& t, const RefTwoBodyInt& tbi, const RefIntegral ints,
