...
template double** new_c_array2<double>(int,int);
template double** new_zero_c_array2<double>(int,int);
template void delete_c_array3<double>(double***);
template double*** new_c_array3<double>(int,int,int);
template double*** new_zero_c_array3<double>(int,int,int);
#endif
