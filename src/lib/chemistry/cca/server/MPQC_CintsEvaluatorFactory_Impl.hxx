// 
// File:          MPQC_CintsEvaluatorFactory_Impl.hxx
...
#ifndef included_MPQC_CintsEvaluatorFactory_Impl_hxx
#define included_MPQC_CintsEvaluatorFactory_Impl_hxx
...
#endif
#ifndef included_MPQC_CintsEvaluatorFactory_hxx
...
// DO-NOT-DELETE splicer.begin(MPQC.CintsEvaluatorFactory._hincludes)
#include <sstream>
#include <vector>
#include <chemistry/qc/basis/gaussbas.h>
#include <chemistry/qc/cints/cints.h>
// DO-NOT-DELETE splicer.end(MPQC.CintsEvaluatorFactory._hincludes)
...
namespace MPQC { 
   ...
   */
  class CintsEvaluatorFactory_impl : public virtual 
  ...
  protected:
    ...
    Chemistry::QC::GaussianBasis::CompositeDescrInterface 
      cdesc_no_deriv_;
    std::vector< Chemistry::QC::GaussianBasis::CompositeDescrInterface > 
      comps_;
    std::vector< sc::Ref<sc::TwoBodyInt> > grts_;
    gov::cca::Services services_;
    int storage_;
    sc::Ref<sc::IntegralCints> integral_;
  ...
  public:
    ...
    // (fixes bug #275)
      CintsEvaluatorFactory_impl( struct MPQC_CintsEvaluatorFactory__object * 
      ...
      ::Chemistry::QC::GaussianBasis::IntegralEvaluatorFactoryInterface((
        ior==NULL) ? NULL : &((
        *ior).d_chemistry_qc_gaussianbasis_integralevaluatorfactoryinterface)),
...
// DO-NOT-DELETE splicer.begin(MPQC.CintsEvaluatorFactory._hmisc)
// Insert-Code-Here {MPQC.CintsEvaluatorFactory._misc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(MPQC.CintsEvaluatorFactory._hmisc)
