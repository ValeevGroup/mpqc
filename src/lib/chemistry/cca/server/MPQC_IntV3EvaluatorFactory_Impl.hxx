...
// DO-NOT-DELETE splicer.begin(MPQC.IntV3EvaluatorFactory._hincludes)
#include <sstream>
#include <vector>
#include <chemistry/qc/basis/gaussbas.h>
#include <chemistry/qc/intv3/intv3.h>
#include <sidl_SIDLException.hxx>
// DO-NOT-DELETE splicer.end(MPQC.IntV3EvaluatorFactory._hincludes)
...
namespace MPQC { 
  ...
  public:
    ...
    // (fixes bug #275)
      IntV3EvaluatorFactory_impl( struct MPQC_IntV3EvaluatorFactory__object * 
...
// DO-NOT-DELETE splicer.begin(MPQC.IntV3EvaluatorFactory._hmisc)
// Insert-Code-Here {MPQC.IntV3EvaluatorFactory._misc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(MPQC.IntV3EvaluatorFactory._hmisc)
