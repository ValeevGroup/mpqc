     ...
     if (z->get_spin(p4b)+z->get_spin(q7b)==z->get_spin(h1b)+z->get_spin(h2b)) { 
      if ((z->get_sym(p4b)^(z->get_sym(q7b)^(z->get_sym(h1b)^z->get_sym(h2b))))==z->irrep_e()) { 
       ...
       if (dima0>0L && dima1>0L) { 
        ...
        z->sort_indices4(k_a0,k_a0_sort,z->get_range(p4b),z->get_range(q7b),z->get_range(h1b),z->get_range(h2b),3,2,0,1,+1.0); 
        z->mem()->free_local_double(k_a0); 
        double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
        double* k_a1=z->mem()->malloc_local_double(dima1); 
        i1xn[2]->get_block(q7b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(p6b_1-z->noab()+z->nvab()*(p5b_1-z->noab()))),k_a1); 
        z->sort_indices4(k_a1,k_a1_sort,z->get_range(p5b),z->get_range(p6b),z->get_range(h3b),z->get_range(q7b),2,1,0,3,+1.0); 
        z->mem()->free_local_double(k_a1); 
        double factor=1.0; 
        z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        z->mem()->free_local_double(k_a1_sort); 
      ...
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(p6b),z->get_range(h3b),z->get_range(q7b),0,1,2,3,+1.0); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(p5b),z->get_range(p6b),z->get_range(h3b),z->get_range(q7b),0,1,2,3,-1.0); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_v()^(z->irrep_t()^z->irrep_t()))) { 
          ...
          if (z->get_spin(h8b)+z->get_spin(h9b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
           if ((z->get_sym(h8b)^(z->get_sym(h9b)^(z->get_sym(h3b)^z->get_sym(q7b))))==z->irrep_v()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h8b),z->get_range(h9b),z->get_range(h3b),z->get_range(q7b),3,2,1,0,+1.0); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             in[2]->get_block(h9b_1+z->noab()*(h8b_1+z->noab()*(p6b_1-z->noab()+z->nvab()*(p5b_1-z->noab()))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(p5b),z->get_range(p6b),z->get_range(h8b),z->get_range(h9b),1,0,3,2,+1.0); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h8b==h9b) { 
              factor=factor/2.0; 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(p6b),z->get_range(p5b),z->get_range(q7b),z->get_range(h3b),1,0,3,2,+0.5/0.5); 
        i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_v()^(z->irrep_t()^z->irrep_t()))) { 
          ...
          if (z->get_spin(h8b)+z->get_spin(p5b)==z->get_spin(p9b)+z->get_spin(q7b)) { 
           if ((z->get_sym(h8b)^(z->get_sym(p5b)^(z->get_sym(p9b)^z->get_sym(q7b))))==z->irrep_v()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h8b),z->get_range(p5b),z->get_range(p9b),z->get_range(q7b),3,1,2,0,+1.0); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             in[2]->get_block(h8b_1+z->noab()*(h3b_1+z->noab()*(p9b_1-z->noab()+z->nvab()*(p6b_1-z->noab()))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(p9b),z->get_range(h3b),z->get_range(h8b),2,0,1,3,+1.0); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
             z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (p6b>=p5b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h3b),z->get_range(p6b),z->get_range(q7b),z->get_range(p5b),3,1,0,2,+1.0); 
         i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h3b),z->get_range(p6b),z->get_range(q7b),z->get_range(p5b),1,3,0,2,-1.0); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^z->irrep_v())) { 
          ...
          if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h8b)+z->get_spin(h9b)) { 
           if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h8b)^z->get_sym(h9b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h9b),z->get_range(h3b),z->get_range(q7b),3,2,1,0,+1.0); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h8b==h9b) { 
              factor=factor/2.0; 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(h3b),z->get_range(p6b),z->get_range(p5b),3,2,1,0,+0.5/0.5); 
        i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
      ...
      if (z->get_spin(h8b)+z->get_spin(h9b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(h8b)^(z->get_sym(h9b)^(z->get_sym(h3b)^z->get_sym(q7b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         double* k_a0=z->mem()->malloc_local_double(dima0); 
         z->v2()->get_block(q7b_0+(z->nab())*(h3b_0+(z->nab())*(h9b_0+(z->nab())*(h8b_0))),k_a0); 
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h8b),z->get_range(h9b),z->get_range(h3b),z->get_range(q7b),0,1,2,3,+1.0); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h8b),z->get_range(h9b),z->get_range(h3b),z->get_range(q7b),0,1,2,3,-1.0); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^z->irrep_v())) { 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (p6b>=p5b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(p6b),z->get_range(h3b),z->get_range(p5b),3,1,2,0,-1.0); 
         i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(p6b),z->get_range(h3b),z->get_range(p5b),1,3,2,0,+1.0); 
         i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p5b-z->noab()+z->nvab()*(p6b-z->noab()))),k_c); 
        } 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
           ...
           if ((z->get_sym(p6b)^(z->get_sym(q8b)^(z->get_sym(h2b)^z->get_sym(h9b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h2b<h9b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q8b),z->get_range(h2b),z->get_range(h9b),2,0,1,3,+1.0); 
             } 
             else if (h9b<=h2b) { 
              z->qy()->get_block(h2b_0+z->noab()*(h9b_0+z->noab()*(q8b_0-z->noab()-z->nvab()+z->ncab()*(p6b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q8b),z->get_range(h9b),z->get_range(h2b),3,0,1,2,-1.0); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h7b<h9b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(h9b),z->get_range(h3b),z->get_range(q8b),2,0,3,1,+1.0); 
             } 
             else if (h9b<=h7b) { 
              in[2]->get_block(q8b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(h7b_1+z->noab()*(h9b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h9b),z->get_range(h7b),z->get_range(h3b),z->get_range(q8b),2,1,3,0,-1.0); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
      ...
      if (z->get_spin(h7b)+z->get_spin(h9b)==z->get_spin(h3b)+z->get_spin(q8b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(h9b)^(z->get_sym(h3b)^z->get_sym(q8b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h7b),z->get_range(h9b),z->get_range(h3b),z->get_range(q8b),0,1,2,3,+1.0); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h7b),z->get_range(h9b),z->get_range(h3b),z->get_range(q8b),0,1,2,3,+1.0); 
           ...
           if ((z->get_sym(p5b)^(z->get_sym(q8b)^(z->get_sym(h3b)^z->get_sym(h9b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h3b<h9b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q8b),z->get_range(h3b),z->get_range(h9b),2,0,1,3,+1.0); 
             } 
             else if (h9b<=h3b) { 
              z->qy()->get_block(h3b_0+z->noab()*(h9b_0+z->noab()*(q8b_0-z->noab()-z->nvab()+z->ncab()*(p5b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(q8b),z->get_range(h9b),z->get_range(h3b),3,0,1,2,-1.0); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->v2()->get_block(q8b_1+(z->nab())*(p7b_1+(z->nab())*(p6b_1+(z->nab())*(h9b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h9b),z->get_range(p6b),z->get_range(p7b),z->get_range(q8b),2,1,3,0,+1.0); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
             z->mem()->free_local_double(k_a1_sort); 
          ...
          if (z->get_spin(h8b)+z->get_spin(h9b)==z->get_spin(h2b)+z->get_spin(h3b)) { 
           if ((z->get_sym(h8b)^(z->get_sym(h9b)^(z->get_sym(h2b)^z->get_sym(h3b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h8b),z->get_range(h9b),z->get_range(h2b),z->get_range(h3b),3,2,1,0,+1.0); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->vr2()->get_block(h9b_1+z->noab()*(h8b_1+z->noab()*(p6b_1+(z->nab())*(h7b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(p6b),z->get_range(h8b),z->get_range(h9b),1,0,3,2,+1.0); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h8b==h9b) { 
              factor=factor/2.0; 
         ...
         if (z->get_spin(p6b)+z->get_spin(q8b)==z->get_spin(h2b)+z->get_spin(h3b)) { 
          if ((z->get_sym(p6b)^(z->get_sym(q8b)^(z->get_sym(h2b)^z->get_sym(h3b))))==z->irrep_e()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q8b),z->get_range(h2b),z->get_range(h3b),3,2,0,1,+1.0); 
            z->mem()->free_local_double(k_a0); 
            double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
            double* k_a1=z->mem()->malloc_local_double(dima1); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p5b)==z->get_spin(h8b)) { 
          if ((z->get_sym(p5b)^z->get_sym(h8b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(p6b),z->get_range(h3b),z->get_range(q7b),3,2,1,0,+1.0); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (p6b>=p5b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(h3b),z->get_range(p6b),z->get_range(p5b),3,2,1,0,+1.0); 
         i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(h3b),z->get_range(p6b),z->get_range(p5b),2,3,1,0,-1.0); 
         i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p5b-z->noab()+z->nvab()*(p6b-z->noab()))),k_c); 
        } 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
      ...
      if (z->get_spin(h8b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(h8b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==z->irrep_v()) { 
        ...
        if (dima0>0L) { 
         ...
         z->sort_indices4(k_a0,k_a0_sort,z->get_range(h8b),z->get_range(p6b),z->get_range(h3b),z->get_range(q7b),0,1,2,3,+1.0); 
         z->mem()->free_local_double(k_a0); 
         double* k_c=z->mem()->malloc_local_double(dimc); 
         z->sort_indices4(k_a0_sort,k_c,z->get_range(h8b),z->get_range(p6b),z->get_range(h3b),z->get_range(q7b),0,1,2,3,+1.0); 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p8b)==z->get_spin(h3b)) { 
          if ((z->get_sym(p8b)^z->get_sym(h3b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(p5b),z->get_range(p6b),z->get_range(p8b),z->get_range(q7b),3,1,0,2,+1.0); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(p6b),z->get_range(p5b),z->get_range(h3b),2,1,3,0,-1.0); 
        i1xn[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(p5b)+z->get_spin(p6b)+z->get_spin(h8b)+z->get_spin(h9b)!=8L) { 
      if (z->get_spin(p5b)+z->get_spin(p6b)==z->get_spin(h8b)+z->get_spin(h9b)) { 
       if ((z->get_sym(p5b)^(z->get_sym(p6b)^(z->get_sym(h8b)^z->get_sym(h9b))))==(z->irrep_t()^z->irrep_t())) { 
        ...
        if (z->get_spin(p5b)==z->get_spin(h8b)) { 
         if ((z->get_sym(p5b)^z->get_sym(h8b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           double* k_a0=z->mem()->malloc_local_double(dima0); 
           z->t1()->get_block(h8b_0+z->noab()*(p5b_0-z->noab()),k_a0); 
           z->sort_indices2(k_a0,k_a0_sort,z->get_range(p5b),z->get_range(h8b),1,0,+1.0); 
           z->mem()->free_local_double(k_a0); 
           double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
           double* k_a1=z->mem()->malloc_local_double(dima1); 
           z->t1()->get_block(h9b_1+z->noab()*(p6b_1-z->noab()),k_a1); 
           z->sort_indices2(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(h9b),1,0,+1.0); 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
           z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        if (p6b>=p5b && h9b>=h8b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h9b),z->get_range(p6b),z->get_range(h8b),z->get_range(p5b),3,1,2,0,-0.5); 
         in[2]->add_block(h9b+z->noab()*(h8b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p6b>=p5b && h8b>=h9b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h9b),z->get_range(p6b),z->get_range(h8b),z->get_range(p5b),3,1,0,2,+0.5); 
         in[2]->add_block(h8b+z->noab()*(h9b+z->noab()*(p6b-z->noab()+z->nvab()*(p5b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b && h9b>=h8b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h9b),z->get_range(p6b),z->get_range(h8b),z->get_range(p5b),1,3,2,0,+0.5); 
         in[2]->add_block(h9b+z->noab()*(h8b+z->noab()*(p5b-z->noab()+z->nvab()*(p6b-z->noab()))),k_c); 
        } 
        if (p5b>=p6b && h8b>=h9b) { 
         z->sort_indices4(k_c_sort,k_c,z->get_range(h9b),z->get_range(p6b),z->get_range(h8b),z->get_range(p5b),1,3,0,2,-0.5); 
     ...
     if (!z->restricted() || z->get_spin(p6b)+z->get_spin(p9b)+z->get_spin(h3b)+z->get_spin(h8b)!=8L) { 
      if (z->get_spin(p6b)+z->get_spin(p9b)==z->get_spin(h3b)+z->get_spin(h8b)) { 
       if ((z->get_sym(p6b)^(z->get_sym(p9b)^(z->get_sym(h3b)^z->get_sym(h8b))))==(z->irrep_t()^z->irrep_t())) { 
        ...
        if (z->get_spin(p9b)==z->get_spin(h3b)) { 
         if ((z->get_sym(p9b)^z->get_sym(h3b))==z->irrep_t()) { 
          ...
          if (dima0>0L && dima1>0L) { 
           ...
           z->sort_indices2(k_a1,k_a1_sort,z->get_range(p6b),z->get_range(h8b),1,0,+1.0); 
           z->mem()->free_local_double(k_a1); 
           double factor=1.0; 
           z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
           z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(h8b),z->get_range(p6b),z->get_range(h3b),z->get_range(p9b),1,3,2,0,-1.0); 
     ...
     if (!z->restricted() || z->get_spin(h8b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(h8b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(h8b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^(z->irrep_t()^z->irrep_v()))) { 
          ...
          if ((z->get_sym(p6b)^z->get_sym(h9b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            if (h8b<h9b) { 
             ...
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h9b),z->get_range(h3b),z->get_range(q7b),3,2,0,1,+1.0); 
            } 
            else if (h9b<=h8b) { 
             in[3]->get_block(q7b_1-z->noab()-z->nvab()+z->ncab()*(h3b_1+z->noab()*(h8b_1+z->noab()*(h9b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h9b),z->get_range(h8b),z->get_range(h3b),z->get_range(q7b),3,2,1,0,-1.0); 
            } 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(h3b),z->get_range(h8b),z->get_range(p6b),2,3,1,0,+0.5); 
        in[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(h8b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(h8b)+z->get_spin(p6b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(h8b)+z->get_spin(p6b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(h8b)^(z->get_sym(p6b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^z->irrep_v())) { 
           ...
           if ((z->get_sym(p6b)^(z->get_sym(p9b)^(z->get_sym(h3b)^z->get_sym(h10b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h8b<h10b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h10b),z->get_range(p9b),z->get_range(q7b),3,0,2,1,+1.0); 
             } 
             else if (h10b<=h8b) { 
              z->v2()->get_block(q7b_1+(z->nab())*(p9b_1+(z->nab())*(h8b_1+(z->nab())*(h10b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h10b),z->get_range(h8b),z->get_range(p9b),z->get_range(q7b),3,1,2,0,-1.0); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(h8b),z->get_range(h3b),z->get_range(p6b),1,3,2,0,+1.0); 
        in[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(p6b-z->noab()+z->nvab()*(h8b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
     ...
     if (!z->restricted() || z->get_spin(h8b)+z->get_spin(h9b)+z->get_spin(h3b)+z->get_spin(q7b)!=8L) { 
      if (z->get_spin(h8b)+z->get_spin(h9b)==z->get_spin(h3b)+z->get_spin(q7b)) { 
       if ((z->get_sym(h8b)^(z->get_sym(h9b)^(z->get_sym(h3b)^z->get_sym(q7b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p10b)==z->get_spin(h3b)) { 
          if ((z->get_sym(p10b)^z->get_sym(h3b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h9b),z->get_range(p10b),z->get_range(q7b),3,1,0,2,+1.0); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q7b),z->get_range(h9b),z->get_range(h8b),z->get_range(h3b),2,1,3,0,-1.0); 
        in[2]->add_block(q7b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(h9b+z->noab()*(h8b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
           ...
           if ((z->get_sym(p6b)^(z->get_sym(q9b)^(z->get_sym(h3b)^z->get_sym(h10b))))==z->irrep_e()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             if (h3b<h10b) { 
              ...
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q9b),z->get_range(h3b),z->get_range(h10b),2,0,1,3,+1.0); 
             } 
             else if (h10b<=h3b) { 
              z->qy()->get_block(h3b_0+z->noab()*(h10b_0+z->noab()*(q9b_0-z->noab()-z->nvab()+z->ncab()*(p6b_0-z->noab()))),k_a0); 
              z->sort_indices4(k_a0,k_a0_sort,z->get_range(p6b),z->get_range(q9b),z->get_range(h10b),z->get_range(h3b),3,0,1,2,-1.0); 
             } 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             if (h8b<h10b) { 
              ...
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h8b),z->get_range(h10b),z->get_range(p7b),z->get_range(q9b),2,0,3,1,+1.0); 
             } 
             else if (h10b<=h8b) { 
              z->v2()->get_block(q9b_1+(z->nab())*(p7b_1+(z->nab())*(h8b_1+(z->nab())*(h10b_1))),k_a1); 
              z->sort_indices4(k_a1,k_a1_sort,z->get_range(h10b),z->get_range(h8b),z->get_range(p7b),z->get_range(q9b),2,1,3,0,-1.0); 
             } 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
     ...
     if (!z->restricted() || z->get_spin(h7b)+z->get_spin(h9b)+z->get_spin(h3b)+z->get_spin(q8b)!=8L) { 
      if (z->get_spin(h7b)+z->get_spin(h9b)==z->get_spin(h3b)+z->get_spin(q8b)) { 
       if ((z->get_sym(h7b)^(z->get_sym(h9b)^(z->get_sym(h3b)^z->get_sym(q8b))))==(z->irrep_t()^z->irrep_v())) { 
         ...
         if (z->get_spin(p10b)==z->get_spin(h3b)) { 
          if ((z->get_sym(p10b)^z->get_sym(h3b))==z->irrep_t()) { 
           ...
           if (dima0>0L && dima1>0L) { 
            ...
            z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(h9b),z->get_range(p10b),z->get_range(q8b),3,1,0,2,+1.0); 
            z->mem()->free_local_double(k_a1); 
            double factor=1.0; 
            z->smith_dgemm(dima0_sort,dima1_sort,dim_common,factor,k_a0_sort,dim_common,k_a1_sort,dim_common,1.0,k_c_sort,dima0_sort); 
            z->mem()->free_local_double(k_a1_sort); 
        ...
        double* k_c=z->mem()->malloc_local_double(dimc); 
        z->sort_indices4(k_c_sort,k_c,z->get_range(q8b),z->get_range(h9b),z->get_range(h7b),z->get_range(h3b),2,1,3,0,+1.0); 
        in[2]->add_block(q8b-z->noab()-z->nvab()+z->ncab()*(h3b+z->noab()*(h9b+z->noab()*(h7b))),k_c); 
        z->mem()->free_local_double(k_c); 
        z->mem()->free_local_double(k_c_sort); 
       } 
          ...
          if (z->get_spin(h9b)+z->get_spin(h10b)==z->get_spin(h2b)+z->get_spin(h3b)) { 
           if ((z->get_sym(h9b)^(z->get_sym(h10b)^(z->get_sym(h2b)^z->get_sym(h3b))))==z->irrep_t()) { 
            ...
            if (dima0>0L && dima1>0L) { 
             ...
             z->sort_indices4(k_a0,k_a0_sort,z->get_range(h9b),z->get_range(h10b),z->get_range(h2b),z->get_range(h3b),3,2,1,0,+1.0); 
             z->mem()->free_local_double(k_a0); 
             double* k_a1_sort=z->mem()->malloc_local_double(dima1); 
             double* k_a1=z->mem()->malloc_local_double(dima1); 
             z->vr2()->get_block(h10b_1+z->noab()*(h9b_1+z->noab()*(h8b_1+(z->nab())*(h7b_1))),k_a1); 
             z->sort_indices4(k_a1,k_a1_sort,z->get_range(h7b),z->get_range(h8b),z->get_range(h9b),z->get_range(h10b),1,0,3,2,+1.0); 
             z->mem()->free_local_double(k_a1); 
             double factor=1.0; 
             if (h9b==h10b) { 
              factor=factor/2.0; 
