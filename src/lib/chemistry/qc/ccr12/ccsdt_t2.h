...
class CCSDT_T2 {
  ...
  protected:
   ...
   void smith_1_32(); //z->t2(),z->v2()=>in.at(1)
   ...
   void smith_1_33(); //z->t2(),z->v2()=>in.at(1)
   ...
   void smith_1_36(); //z->t1(),z->v2()=>in.at(1)
