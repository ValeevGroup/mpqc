...
class LAMBDA_CCSD_T2 {
  ...
  protected:
   ...
   void smith_0_9(Ref<Tensor>&); //z->l2(),in.at(1)=>out
   void offset_smith_0_11();
   void smith_1_11(); //z->t1(),z->l2()=>in.at(1)
   void smith_0_11(Ref<Tensor>&); //z->f1(),in.at(1)=>out
   ...
   void smith_0_12(Ref<Tensor>&); //z->l2(),in.at(1)=>out
   ...
   void smith_0_13(Ref<Tensor>&); //z->l2(),in.at(1)=>out
   void smith_0_14(Ref<Tensor>&); //z->l2(),z->v2()=>out
   void offset_smith_0_18();
   void smith_1_18(); //z->t1(),z->l2()=>in.at(1)
   void smith_0_18(Ref<Tensor>&); //z->v2(),in.at(1)=>out
   void offset_smith_0_20();
   void smith_1_20(); //z->t1(),z->l2()=>in.at(1)
   void smith_0_20(Ref<Tensor>&); //z->v2(),in.at(1)=>out
   void offset_smith_0_25();
   void offset_smith_1_25();
   void smith_2_25(); //z->t1(),z->l2()=>in.at(2)
   void smith_1_25(); //z->t1(),in.at(2)=>in.at(1)
   void smith_1_31(); //z->t2(),z->l2()=>in.at(1)
   void smith_0_25(Ref<Tensor>&); //z->v2(),in.at(1)=>out
   void offset_smith_0_29();
   void smith_1_29(); //z->t2(),z->l2()=>in.at(1)
   void smith_0_29(Ref<Tensor>&); //z->v2(),in.at(1)=>out
   void offset_smith_0_30();
   void smith_1_30(); //z->t2(),z->l2()=>in.at(1)
   void smith_0_30(Ref<Tensor>&); //z->v2(),in.at(1)=>out
