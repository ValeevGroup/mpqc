...
#include <chemistry/qc/libint2/grt.h>
#ifdef DMALLOC
#include <dmalloc.h>
#endif
...
GRTLibint2::GRTLibint2(Integral *integral,
...
size_t
GRTLibint2::storage_required(const Ref<GaussianBasisSet>& b1,
			   const Ref<GaussianBasisSet>& b2,
			   const Ref<GaussianBasisSet>& b3,
			   const Ref<GaussianBasisSet>& b4)
{
