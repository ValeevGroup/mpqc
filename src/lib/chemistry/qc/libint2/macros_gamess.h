...
#ifndef _chemistry_qc_libint2_macrosgamess_h_
#define _chemistry_qc_libint2_macrosgamess_h_
...
#include <cgshellinfo.h>  // provided by libint2
 ...
 */
#define INT_CARTINDEX(am,i,j) libint2::CGShellInfo< libint2::CGShellOrderingData<libint2::CGShellOrdering_GAMESS,LIBINT_MAX_AM> >::cartindex(am,i,j)
...
#define FOR_CART(i,j,k,am) for(int __xyz=0; __xyz<INT_NCART(am); ++__xyz) { \
    libint2::CGShellInfo< libint2::CGShellOrderingData<libint2::CGShellOrdering_GAMESS,LIBINT_MAX_AM> >::cartindex_to_ijk(am,__xyz,i,j,k);
#define END_FOR_CART }
