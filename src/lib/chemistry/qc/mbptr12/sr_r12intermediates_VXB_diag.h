...
//                  << std::endl;
    ...
    TArray2 Dbn_CT2_cc(Xam_CT2_cc.get_world(), Xam_CT2_cc.trange());
    ...
    TArray2 Dbn_VT_cc(Xam_VT_cc.get_world(), Xam_VT_cc.trange());
    auto resnorm_VT_cc = cg_solver2(Orbital_relaxation_Abnam,
                                    Xam_VT_cc,
                                    Dbn_VT_cc,
                                    preconditioner,
                                    1e-10);
