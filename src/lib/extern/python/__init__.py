...
for i in dir(mpqc):
    ...
    if mpqc.__dict__[i].__class__ == mpqc.Molecule.__class__:
        mpqc.__dict__[i].__init_boost__ = mpqc.__dict__[i].__init__
        mpqc.__dict__[i].__init_keyval__ = __init_keyval__
        mpqc.__dict__[i].__init__ = __init_general__
