...
namespace mpqc {
  namespace ci {
    ...
    size_t sigma2(const String &I, const String::List<L> &list, const Vector &h,
                  const Matrix &V, const Eigen::MatrixBase<F_> &f,
                  const CI<Type> &ci) {
     ...
     */
    template<class Type>
    void sigma(const CI<Type> &ci, const Vector &h, const Matrix &V,
               const mpqc::Array<double> &C, mpqc::Array<double> &S) {
