...
namespace ci {
    ...
    void replacements(const String::List<L> &list, size_t s, Replacement::Single &r,
                      const CI &ci) {
    ...
    template<class L, class CI>
    Replacement::Single
    replacements(const String::List<L> &list, size_t s, const CI &ci) {
    ...
    template<class L, class CI>
    Replacement::Single
    replacements(const String::List<L> &list, size_t begin, size_t end,
                 const CI &ci) {
    ...
    size_t sigma3(const Replacement::Single &A,
                  const std::vector<int> &index,
                  const Matrix &V, const Vector &C,
                  Matrix &S) {
        size_t ops = 0;
    ...
    void sigma3(int n, const double *v, const double *c,
                int phase, double* __restrict__ s) {
    ...
    size_t sigma3(const Replacement::Single &A,
                  const Matrix &V, const Matrix &C,
                  Matrix &S, size_t offset = 0) {
        foreach (auto const &ij, A) {
            sigma3(S.rows(),
