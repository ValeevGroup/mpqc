...
std::vector<std::shared_ptr<Cluster>> attach_hydrogens_kmeans(
    Molecule const &m, unsigned long nclusters) {
...
std::vector<std::shared_ptr<Cluster>> kmeans(Molecule const &m,
