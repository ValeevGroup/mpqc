...
mpqc::detail::ForceLink<GammaPointCCSDVersion2<TA::TensorD, TA::DensePolicy>> fl4;
...
mpqc::detail::ForceLink<GammaPointCCSDVersion2<TA::TensorD, TA::SparsePolicy>> fl4;
#endif
}  // namespace
}  // namespace lcao
}  // namespace mpqc
