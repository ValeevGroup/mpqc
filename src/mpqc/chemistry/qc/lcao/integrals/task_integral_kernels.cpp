...
TA::TensorD integral_kernel(Engine &eng, TA::Range &&rng,
  ...
  auto restrict tile_ptr_first = tile.data();
    ...
    for (auto idx1 = 0ul; idx1 < end1; ++idx1) {
      ...
      if (ints_shell_sets[0] != nullptr) {
        ...
        for (auto el0 = lb0; el0 < ub0; ++el0) {
          ...
          auto restrict tile_ptr = tile_ptr_first + el0_pre;
            ...
            if (!screen.skip(lb0, lb1, lb2)) {
              ...
              if (ints_shell_sets[0] != nullptr) {
                ...
                for (auto el0 = lb0; el0 < ub0; ++el0) {
                  ...
                  auto restrict tile_ptr0 = tile_ptr_first + el0_pre;
                  for (auto el1 = lb1; el1 < ub1; ++el1) {
                    const auto el1_pre = ext2 * el1;
                    auto restrict tile_ptr1 = tile_ptr0 + el1_pre;
                    ...
                    for (auto el0 = lb0; el0 < ub0; ++el0) {
                      ...
                      for (auto el1 = lb1; el1 < ub1; ++el1) {
                        ...
                        for (auto el2 = lb2; el2 < ub2; ++el2) {
                          ...
                          auto restrict tile_ptr2 = tile_ptr1 + el2_pre;
