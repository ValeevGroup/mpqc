...
mpqc::detail::ForceLink<GammaPointMP2Version2<TA::TensorD, TA::DensePolicy>> fl5;
...
mpqc::detail::ForceLink<GammaPointMP2Version2<TA::TensorD, TA::SparsePolicy>> fl5;
