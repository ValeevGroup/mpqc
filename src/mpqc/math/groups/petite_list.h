...
struct TupleCanonicalizer<PetiteList::Symmetry::a_bb> {
  ...
  template <typename I>
  static bool is_canonical(I idx0, I idx1, I idx2, I idx3) {
    return is_canonical(idx0, idx1, idx2);
  }
  template <typename I>
  static int64_t multiplicity(I idx0) {
    throw std::logic_error(
        "undefined TupleCanonicalizer<a_bb>::multiplicity()");
  }
  template <typename I>
  static int64_t multiplicity(I idx0, I idx1) {
    throw std::logic_error(
  ...
  template <typename I>
  static int64_t multiplicity(I idx0, I idx1, I idx2, I idx3) {
    return multiplicity(idx0, idx1, idx2);
  }
};
...
struct TupleCanonicalizer<PetiteList::Symmetry::aa_aa> {
  ...
  static int64_t multiplicity(I idx0) {
    throw std::logic_error(
        "underfined TupleCanonicalizer<aa_aa>::multiplicity()");
  }
  template <typename I>
  static int64_t multiplicity(I idx0, I idx1) {
    throw std::logic_error(
...
struct TupleCanonicalizer<PetiteList::Symmetry::aa_bb> {
  ...
  static int64_t multiplicity(I idx0) {
    throw std::logic_error(
        "undefined TupleCanonicalizer<aa_bb>::multiplicity()");
  }
  template <typename I>
  static int64_t multiplicity(I idx0, I idx1) {
    throw std::logic_error(
...
struct TupleCanonicalizer<PetiteList::Symmetry::ab_ab> {
  ...
  static int64_t multiplicity(I idx0) {
    throw std::logic_error(
        "undefined TupleCanonicalizer<ab_ab>::multiplicity()");
  }
  template <typename I>
  static int64_t multiplicity(I idx0, I idx1) {
    throw std::logic_error(
